...
server's address, and click **Sign in on …**. The server's own
page opens; sign in there with the credentials your administrator gave
you (or your identity provider) and approve the device. The extension
reads **Signed in as** you — click **Connect**, and the server's
workspaces sync down. Nothing is pasted into the extension; see
