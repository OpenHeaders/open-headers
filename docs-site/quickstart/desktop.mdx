...
<Tabs>
  <Tab title="macOS" icon="/images/macos.svg">
    ...
    - [Apple silicon (`mac-arm64`)](https://updates.openheaders.com/dl/v2026.9.3/OpenHeaders-2026.9.3-mac-arm64.dmg)
    - [Intel (`mac-x64`)](https://updates.openheaders.com/dl/v2026.9.3/OpenHeaders-2026.9.3-mac-x64.dmg)
  ...
  <Tab title="Windows" icon="/images/windows.svg">
    ...
    - [Installer (`Setup.exe`)](https://updates.openheaders.com/dl/v2026.9.3/OpenHeaders-2026.9.3-Setup.exe)
    - [Managed/silent installs (`.msi`)](https://updates.openheaders.com/dl/v2026.9.3/OpenHeaders-2026.9.3.msi)
  </Tab>
  <Tab title="Linux" icon="/images/linux.svg">
    Download the package for your distribution and architecture:

    - Debian/Ubuntu: [`amd64.deb`](https://updates.openheaders.com/dl/v2026.9.3/open-headers_2026.9.3_amd64.deb) · [`arm64.deb`](https://updates.openheaders.com/dl/v2026.9.3/open-headers_2026.9.3_arm64.deb)
    - Fedora/RHEL/openSUSE: [`x86_64.rpm`](https://updates.openheaders.com/dl/v2026.9.3/open-headers-2026.9.3.x86_64.rpm) · [`aarch64.rpm`](https://updates.openheaders.com/dl/v2026.9.3/open-headers-2026.9.3.aarch64.rpm)
    - Distro-agnostic: [`x86_64.AppImage`](https://updates.openheaders.com/dl/v2026.9.3/OpenHeaders-2026.9.3-x86_64.AppImage) · [`arm64.AppImage`](https://updates.openheaders.com/dl/v2026.9.3/OpenHeaders-2026.9.3-arm64.AppImage)
...
Working with a team on an [Open Headers Server](/quickstart/server)?
Open the workbench window, then **Settings → Backup and Sync → Sign in
to a server…**, add the server's address, and click **Sign in on …**.
Your browser opens the server's consent page; sign in there with the
credentials your administrator gave you (or your identity provider)
and approve the device. The browser hands you back to the app, which
reads **Signed in as** you — click **Connect**, and the server's
workspaces sync down. The password never leaves the browser; see
[Tokens & pairing](/server/tokens-and-pairing) for the whole story.
