...
Your browser opens the server's own page; sign in there with
the credentials your administrator gave you (or your identity provider)
and approve the device. The app reads **Signed in as** you — click
**Connect**, and the server's workspaces sync down. See
