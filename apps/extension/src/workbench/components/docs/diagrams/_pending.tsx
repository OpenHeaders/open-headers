...
export const HeaderOpsDiagram: React.FC = () => (
  <svg
    ...
    style={{ maxWidth: 320 }}
    role="img"
    aria-label="How Override, Append, Remove, and Merge transform the same header set"
  >
    <ArrowDefs id="ho-arrow" />
    <text x="150" y="14" textAnchor="middle" fontSize="10" fontWeight="600" fill={TEXT}>
      Before
    </text>
    <rect x="80" y="20" width="140" height="38" rx="3" fill={FILL_BLUE} stroke={STROKE_BLUE} />
    <text x="150" y="35" textAnchor="middle" fontFamily="monospace" fontSize="10" fill={TEXT}>
      Cookie: a=1
    </text>
    <text x="150" y="49" textAnchor="middle" fontFamily="monospace" fontSize="10" fill={TEXT}>
      Auth: t1
    </text>
    <line x1="150" y1="62" x2="150" y2="78" stroke={STROKE} strokeWidth="1.5" markerEnd="url(#ho-arrow)" />
    <text x="75" y="92" textAnchor="middle" fontSize="9" fontWeight="600" fill={TEXT}>
      Override Cookie: Z
    </text>
    <rect x="10" y="98" width="130" height="42" rx="3" fill={FILL_GREEN} stroke={STROKE_GREEN} />
    <text x="75" y="114" textAnchor="middle" fontFamily="monospace" fontSize="10" fontWeight="600" fill={TEXT}>
      Cookie: Z
    </text>
    <text x="75" y="128" textAnchor="middle" fontFamily="monospace" fontSize="10" fill={TEXT}>
      Auth: t1
    </text>
    <text x="225" y="92" textAnchor="middle" fontSize="9" fontWeight="600" fill={TEXT}>
      Append Cookie: Z
    </text>
    <rect x="160" y="98" width="130" height="56" rx="3" fill={FILL_GREEN} stroke={STROKE_GREEN} />
    <text x="225" y="114" textAnchor="middle" fontFamily="monospace" fontSize="10" fill={TEXT}>
      Cookie: a=1
    </text>
    <text x="225" y="128" textAnchor="middle" fontFamily="monospace" fontSize="10" fontWeight="600" fill={TEXT}>
      Cookie: Z
    </text>
    <text x="225" y="142" textAnchor="middle" fontFamily="monospace" fontSize="10" fill={TEXT}>
      Auth: t1
    </text>
    <text x="75" y="180" textAnchor="middle" fontSize="9" fontWeight="600" fill={TEXT}>
      Remove Cookie
    </text>
    <rect x="10" y="186" width="130" height="42" rx="3" fill={FILL_GREEN} stroke={STROKE_GREEN} />
    <text
      x="75"
      y="202"
      textAnchor="middle"
    ...
    <text x="75" y="216" textAnchor="middle" fontFamily="monospace" fontSize="10" fill={TEXT}>
      Auth: t1
    </text>
    <text x="225" y="180" textAnchor="middle" fontSize="9" fontWeight="600" fill={TEXT}>
      Merge Cookie + b=2
    </text>
    <rect x="160" y="186" width="130" height="42" rx="3" fill={FILL_PURPLE} stroke={STROKE_PURPLE} />
    <text x="225" y="202" textAnchor="middle" fontFamily="monospace" fontSize="10" fontWeight="600" fill={TEXT}>
      Cookie: a=1; b=2
    </text>
    <text x="225" y="216" textAnchor="middle" fontFamily="monospace" fontSize="10" fill={TEXT}>
      Auth: t1
    </text>
    <rect x="20" y="252" width="10" height="10" fill={FILL_GREEN} stroke={STROKE_GREEN} />
    <text x="35" y="261" fontSize="9" fill={TEXT_DIM}>
      DNR (native)
    </text>
    <rect x="170" y="252" width="10" height="10" fill={FILL_PURPLE} stroke={STROKE_PURPLE} />
    <text x="185" y="261" fontSize="9" fill={TEXT_DIM}>
      Script-based (Merge only)
    </text>
  </svg>
);
