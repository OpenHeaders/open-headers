...
// Half-split within the left/right sidebar column (only drawn in that
// column when the target slot lives in it).
const SIDE_HALF_Y = 8;

// Nested bottom strip (only shown for bottom-* slots, as full width).
