...
import { resolveInitiatorRootUrl } from '@openheaders/ui/panel/data/initiator/initiator-graph';
...
describe('resolveInitiatorRootUrl', () => {
  ...
  it('returns initiator.url for parser-initiated requests', () => {
    expect(resolveInitiatorRootUrl(har({ type: 'parser', url: 'https://openheaders.io/' }))).toBe(
