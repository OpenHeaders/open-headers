...
describe('WSEnvironmentHandler', () => {
  ...
  describe('resolveTemplate', () => {
    it('replaces single variable', () => {
      const result = handler.resolveTemplate('Bearer {{TOKEN}}', {
    ...
    it('resolves enterprise-style connection string variables', () => {
      ...
      expect(result).toBe(
        'postgresql://openheaders_app:P@$$w0rd!2026@db.openheaders.internal:5432/openheaders_production?sslmode=require',
      );
    });
