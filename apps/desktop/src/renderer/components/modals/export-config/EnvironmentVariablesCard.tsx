import { DatabaseOutlined, SafetyOutlined, WarningOutlined } from '@ant-design/icons';
import type { RadioChangeEvent } from 'antd';
import { Card, Checkbox, Divider, Empty, Radio, Space, Spin, Typography } from 'antd';
    ...
    <Card
      ...
      title={
        <Space>
          ...
          {exportPurpose === 'team' && <SafetyOutlined style={{ color: '#52c41a', fontSize: 16 }} />}
        </Space>
      }
    >
