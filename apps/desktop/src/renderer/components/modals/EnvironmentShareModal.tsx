...
const EnvironmentShareModal = ({ visible, environmentName, environmentData, onClose }: EnvironmentShareModalProps) => {
  ...
  return (
    <Modal
      title={
        <Space>
          Share environment <DatabaseOutlined />
          {environmentName}
        </Space>
      }
      open={visible}
    ...
    >
      <Space orientation="vertical" style={{ width: '100%' }} size={20}>
              ...
              <span style={{ lineHeight: 1, display: 'inline-flex', alignItems: 'center', gap: 6 }}>
                ...
                >
                  <QuestionCircleOutlined
                    style={{ fontSize: 12, color: token.colorPrimary, cursor: 'help', verticalAlign: 'middle' }}
                  />
                </Tooltip>
              </span>
            </Checkbox>
        ...
        >
          ...
          >
            <li style={{ marginBottom: 4 }}>Recipient opens this link in their browser</li>
            <li style={{ marginBottom: 4 }}>Browser automatically opens OpenHeaders app to show Import dialog</li>
