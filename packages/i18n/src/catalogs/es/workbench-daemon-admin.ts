...
export const workbenchDaemonAdmin = {
  // ── Console shell ──────────────────────────────────────────────────
  'workbench.daemonAdmin.title': 'Administración del servidor',
  'workbench.daemonAdmin.intro':
    ...
    'inmediato.',
  'workbench.daemonAdmin.deniedDescription': 'Administrar este servidor requiere la capacidad daemon.admin.',
