...
export const sharedComponents = {
  ...
  'shared.codeEditor.find': 'Buscar',
  'shared.codeEditor.replace': 'Reemplazar',
  'shared.codeEditor.format': 'Formatear',
  'shared.codeEditor.formatError': 'No se puede formatear — error de análisis',
  ...
  'shared.peerExecute.localDisabled':
    ...
    'Activa «Permitir que los navegadores de este dispositivo envíen solicitudes» en Copia de seguridad y sincronización › Tus dispositivos.',
  ...
  'shared.executionPlace.knob.cookieJar': 'el cookie jar',
