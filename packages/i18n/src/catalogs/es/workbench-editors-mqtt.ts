...
export const workbenchEditorsMqtt = {
  ...
  'workbench.editors.mqtt.timeline.scriptFailed': '{hook} falló — {error}',
  'workbench.editors.mqtt.timeline.scriptDropped': '{hook} descartó el mensaje — {level}',
  'workbench.editors.mqtt.timeline.scriptAttempt': 'intento {attempt}',
  'workbench.editors.mqtt.session.scripts.empty': 'Ningún script se ha ejecutado en esta sesión.',
  'workbench.editors.mqtt.session.scripts.console': 'Consola',
  'workbench.editors.mqtt.session.scripts.tests': 'Pruebas',
  'workbench.editors.mqtt.session.scripts.consoleEmpty': 'Nada registrado.',
  'workbench.editors.mqtt.session.scripts.testsEmpty': 'Ninguna aserción registrada.',
  'workbench.editors.mqtt.session.scripts.attempt': 'intento {attempt}',
  'workbench.editors.mqtt.session.scripts.atMessage': 'evento {index}',
  'workbench.editors.mqtt.session.scripts.tag': 'Scripts · {count}',
  'workbench.editors.mqtt.session.scripts.tagTitle': 'Scripts de sesión',
  'workbench.editors.mqtt.session.scripts.tagSummary':
    'Los hooks ejecutados en esta sesión, con los niveles que contribuyeron.',
  'workbench.editors.mqtt.session.scripts.tagSummaryFailed': 'Un hook falló — su último error aparece debajo.',
  'workbench.editors.mqtt.session.scripts.runs': '{count} ejecuciones',
  'workbench.editors.mqtt.session.scripts.runsOne': '1 ejecución',
