...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.connect.browserHost':
    'Las sesiones WebSocket se ejecutan en la aplicación de escritorio o el daemon.',
  ...
  'workbench.editors.websocket.auth.helpRaw':
    ...
    'escritorio o el daemon; los navegadores no pueden definirlo en un WebSocket. Una fila de encabezado ' +
  ...
  'workbench.editors.websocket.auth.helpSocketio':
    ...
    'handshake Authorization: Bearer en la aplicación de escritorio o el daemon. Una fila de encabezado ' +
  ...
  'workbench.editors.websocket.headers.nodeOnly':
    ...
    'escritorio o el daemon — los navegadores no pueden definirlos en un WebSocket.',
