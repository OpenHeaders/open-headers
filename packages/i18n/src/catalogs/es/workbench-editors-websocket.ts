...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.timeline.showHexdump': 'Mostrar el volcado hexadecimal',
  'workbench.editors.websocket.timeline.showMessage': 'Mostrar el mensaje',
  'workbench.editors.websocket.timeline.viewerFormat': 'Formato del mensaje',
