...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.settings.exampleCaption': 'Sesión de ejemplo',
  ...
  'workbench.editors.websocket.settings.group.resilience': 'Resiliencia de sesión',
  'workbench.editors.websocket.settings.groupInfo.resilience':
    'Lo que mantiene viva una sesión larga: si una conexión caída se reabre y con cuánta paciencia, cuánto silencio se tolera antes de dar la conexión por perdida, y el latido que envía este cliente.',
  ...
  'workbench.editors.websocket.settings.groupInfo.socketio':
    'Cómo la sesión Socket.IO dirige y habla al servidor: la ruta de handshake de engine.io que monta, el espacio de nombres al que se une, la revisión del protocolo y cuánto espera un evento su ack.',
  ...
  'workbench.editors.websocket.settings.socketioProtocolHelp':
    'La revisión del protocolo Socket.IO que habla la sesión. v5 (engine.io 4) es la de los servidores Socket.IO 3.x y 4.x; elige v4 (engine.io 3) para un servidor 1.x o 2.x — ahí el cliente envía los pings, el servidor se une al namespace raíz por su cuenta y el paquete connect no lleva carga de autenticación, así que la credencial bearer viaja solo en la cabecera del handshake.',
  'workbench.editors.websocket.settings.socketioProtocolPlaceholder': 'v5 (predeterminado)',
  'workbench.editors.websocket.settings.socketioProtocolV5': 'v5 — servidores Socket.IO 3.x / 4.x',
  'workbench.editors.websocket.settings.socketioProtocolV4': 'v4 — servidores Socket.IO 1.x / 2.x',
  'workbench.editors.websocket.settings.ackTimeoutLabel': 'Tiempo de espera del ack',
  'workbench.editors.websocket.settings.ackTimeoutHelp':
    'Cuánto espera un evento enviado con Ack la confirmación del servidor. Al agotarse la espera, la línea de tiempo registra el ack como expirado y deja de esperar; un ack tardío se muestra igualmente al llegar. Vacío espera indefinidamente.',
  'workbench.editors.websocket.settings.ackTimeoutPlaceholder': 'Sin tiempo de espera (predeterminado)',
  ...
  'workbench.editors.websocket.session.knobAuth': 'el encabezado de credenciales del handshake',
  ...
  'workbench.editors.websocket.connect.reconnectNow': 'Reconectar ahora',
  'workbench.editors.websocket.connect.reconnectNowHint':
    'Marcar el siguiente intento de reconexión sin esperar el periodo',
  'workbench.editors.websocket.session.reconnectingBadge': 'Reconectando',
  'workbench.editors.websocket.session.reconnectExhaustedTag': 'Reconexión abandonada',
  'workbench.editors.websocket.session.reconnectExhausted': 'reconexión abandonada tras {attempts}',
  'workbench.editors.websocket.session.reconnectExhaustedReason': 'reconexión abandonada tras {attempts}: {reason}',
  'workbench.editors.websocket.session.reconnectAttemptsOne': 'un intento',
  'workbench.editors.websocket.session.reconnectAttemptsMany': '{count} intentos',
  'workbench.editors.websocket.timeline.lost': 'Conexión perdida',
  'workbench.editors.websocket.timeline.lostIdle': 'no llegó nada antes del tiempo de inactividad',
  'workbench.editors.websocket.timeline.reconnectingAfter': 'Intento de reconexión {attempt} tras {delay}',
  'workbench.editors.websocket.timeline.reconnectingNow': 'Intento de reconexión {attempt} ahora',
  'workbench.editors.websocket.timeline.reconnected': 'Reconectado',
  'workbench.editors.websocket.timeline.reconnectedTo': 'Reconectado a {url}',
  'workbench.editors.websocket.timeline.ackTimeout': 'Ack #{ackId} expiró tras {timeout}',
  ...
  'workbench.editors.websocket.timeline.trustCertificate': 'Confiar en el certificado',
  ...
  'workbench.editors.websocket.tab.scripts': 'Scripts',
  'workbench.editors.websocket.timeline.script': '{hook} — {levels}',
  'workbench.editors.websocket.timeline.scriptFailed': '{hook} falló — {error}',
  'workbench.editors.websocket.timeline.scriptDropped': '{hook} descartó el mensaje — {level}',
  'workbench.editors.websocket.timeline.scriptAttempt': 'intento {attempt}',
  'workbench.editors.websocket.session.view.timeline': 'Cronología',
  'workbench.editors.websocket.session.view.scripts': 'Scripts',
  'workbench.editors.websocket.session.scripts.empty': 'Ningún script se ha ejecutado en esta sesión.',
  'workbench.editors.websocket.session.scripts.console': 'Consola',
  'workbench.editors.websocket.session.scripts.tests': 'Pruebas',
  'workbench.editors.websocket.session.scripts.consoleEmpty': 'Nada registrado.',
  'workbench.editors.websocket.session.scripts.testsEmpty': 'Ninguna aserción registrada.',
  'workbench.editors.websocket.session.scripts.attempt': 'intento {attempt}',
  'workbench.editors.websocket.session.scripts.atMessage': 'mensaje {index}',
  'workbench.editors.websocket.session.scripts.tag': 'Scripts · {count}',
  'workbench.editors.websocket.session.scripts.tagTitle': 'Scripts de la sesión',
  'workbench.editors.websocket.session.scripts.tagSummary':
    'Los hooks ejecutados en esta sesión, con los niveles que contribuyeron.',
  'workbench.editors.websocket.session.scripts.tagSummaryFailed': 'Un hook falló — su último error aparece debajo.',
  'workbench.editors.websocket.session.scripts.runs': '{count} ejecuciones',
  'workbench.editors.websocket.session.scripts.runsOne': '1 ejecución',
