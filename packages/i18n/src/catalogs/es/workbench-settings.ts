...
export const workbenchSettings = {
  ...
  'workbench.settings.category.codeEditor.sub.indentation': 'Sangría',
  'workbench.settings.category.codeEditor.sub.wrapping': 'Ajuste de línea',
  'workbench.settings.category.codeEditor.sub.display': 'Visualización',
  'workbench.settings.category.codeEditor.sub.editing': 'Edición',
  ...
  'workbench.settings.category.diffViewer.sub.importPreview': 'Vista previa de importación',
