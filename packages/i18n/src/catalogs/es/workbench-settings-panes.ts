...
export const workbenchSettingsPanes = {
  ...
  'workbench.settings.backendPane.wizard.signIn.cancelSignIn': 'Cancelar inicio de sesión',
  ...
  'workbench.settings.cliAccess.sectionTitle': 'Acceso CLI',
  ...
  'workbench.settings.systemProxy.previewSection': 'Vista previa de ruta',
  ...
  'workbench.settings.systemProxy.manual.credentialsManage': 'Gestionar credenciales en el vault',
  ...
  'workbench.settings.gitPane.section.workingTree': 'Árbol de trabajo',
  'workbench.settings.gitPane.section.branches': 'Ramas',
  'workbench.settings.gitPane.section.commit': 'Commit',
  'workbench.settings.gitPane.section.history': 'Historial',
