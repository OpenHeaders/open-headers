...
export const web = {
  ...
  'web.consent.wouldSignIn': '{who} quiere iniciar sesión en este servidor',
  'web.consent.grantBody':
    'Una vez permitido, el dispositivo actúa en tu nombre en este servidor y puede hacer todo lo que puede hacer tu cuenta.',
  ...
  'web.consent.fromDevice': 'Desde {device}.',
  ...
  'web.consent.switchAccount': 'Cambiar de cuenta',
