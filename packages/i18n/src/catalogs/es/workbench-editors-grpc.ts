...
export const workbenchEditorsGrpc = {
  ...
  'workbench.editors.grpc.method.usingSpec': 'Usando {name}',
  'workbench.editors.grpc.method.refreshSpec': 'Reconstruir desde los archivos actuales de la spec',
  'workbench.editors.grpc.settings.exampleCaption': 'Llamada de ejemplo',
  ...
  'workbench.editors.grpc.timeline.receivedMetadata': '{metadata} recibidos.',
  'workbench.editors.grpc.timeline.receivedMetadataLink': 'Metadatos',
  ...
  'workbench.editors.grpc.timeline.trustCertificate': 'Confiar en el certificado',
  ...
  'workbench.editors.grpc.timeline.scriptFailed': '{hook} falló — {error}',
  'workbench.editors.grpc.response.tab.scripts': 'Scripts',
  'workbench.editors.grpc.scripts.empty': 'Ningún script se ejecutó en esta llamada.',
  'workbench.editors.grpc.scripts.console': 'Consola',
  'workbench.editors.grpc.scripts.tests': 'Pruebas',
  'workbench.editors.grpc.scripts.consoleEmpty': 'No se registró nada.',
  'workbench.editors.grpc.scripts.testsEmpty': 'No se registraron aserciones.',
  'workbench.editors.grpc.scripts.attempt': 'intento {attempt}',
  'workbench.editors.grpc.scripts.atMessage': 'mensaje {index}',
  'workbench.editors.grpc.scripts.tag': 'Scripts · {count}',
  'workbench.editors.grpc.scripts.tagTitle': 'Scripts de la llamada',
  'workbench.editors.grpc.scripts.tagSummary':
    'Los hooks que se ejecutaron en esta llamada, con los niveles que contribuyeron.',
  'workbench.editors.grpc.scripts.tagSummaryFailed': 'Un hook falló — su último error aparece debajo.',
  'workbench.editors.grpc.scripts.runs': '{count} ejecuciones',
  'workbench.editors.grpc.scripts.runsOne': '1 ejecución',
  'workbench.editors.grpc.scripts.failed': '{count} fallidas',
  'workbench.editors.grpc.scripts.dropped': '{count} descartados',
  'workbench.editors.grpc.scripts.marksCapped':
    'El detalle por mensaje se detuvo tras {count} ejecuciones; los hooks siguen ejecutándose y los conteos completos llegan al terminar la llamada.',
