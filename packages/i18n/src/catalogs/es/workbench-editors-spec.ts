...
export const workbenchEditorsSpec = {
  ...
  'workbench.editors.spec.outline.groups.types': 'Tipos',
  'workbench.editors.spec.outline.groups.interfaces': 'Interfaces',
  'workbench.editors.spec.outline.groups.unions': 'Uniones',
  'workbench.editors.spec.outline.groups.inputs': 'Entradas',
  'workbench.editors.spec.outline.groups.scalars': 'Escalares',
  'workbench.editors.spec.outline.groups.directives': 'Directivas',
