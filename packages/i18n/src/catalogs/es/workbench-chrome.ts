...
export const workbenchChrome = {
  ...
  'workbench.shell.commandPalette.cmd.openTrustedRoots': 'Abrir los certificados de confianza',
  ...
  'workbench.shell.statusbar.systemStatus': 'Sistema',
  ...
  'workbench.shell.tabLabel.newMqttRequest': 'Nueva solicitud MQTT',
  'workbench.shell.tabLabel.newGraphqlRequest': 'Nueva solicitud GraphQL',
  ...
  //    rows, drag previews) ───────────────────────────────────────────
  'workbench.toolWindows.serverAdmin': 'Admin del servidor',
  ...
  'workbench.toolWindows.info.serverAdmin.summary':
    'Administra este servidor: los usuarios y sus accesos, los dispositivos emparejados, los enlaces de ' +
    'repositorios y el registro de auditoría. Cada fila abre su propia pestaña.',
  'workbench.toolWindows.info.serverAdmin.domainsHeading': 'Dominios de administración',
  ...
  'workbench.toolWindows.info.git.summary':
    'El historial de commits de la vinculación Git del espacio de trabajo activo — la cronología del espacio ' +
    'de trabajo con los archivos modificados por commit, la autoría y el historial por archivo.',

  // ── Proxy capture tool window (control strip) ──────────────────
  'workbench.proxyCapture.running': 'En ejecución · :{port}',
  'workbench.proxyCapture.stopped': 'Detenido',
  'workbench.proxyCapture.start': 'Iniciar',
  ...
  'workbench.proxyCapture.scopeSaved': 'Ámbito de descifrado actualizado',
  'workbench.proxyCapture.scopeFailed': 'No se pudo actualizar el ámbito: {message}',
  ...
  'workbench.gitLog.filterPlaceholder': 'Texto o hash',
  'workbench.gitLog.filter.regex': 'Expresión regular',
  'workbench.gitLog.filter.matchCase': 'Coincidir mayúsculas',
  'workbench.gitLog.chip.branch': 'Rama',
  'workbench.gitLog.chip.tag': 'Etiqueta',
  'workbench.gitLog.chip.user': 'Usuario',
  'workbench.gitLog.chip.date': 'Fecha',
  'workbench.gitLog.chip.paths': 'Rutas',
  'workbench.gitLog.chip.pathsCount': '{count} rutas',
  'workbench.gitLog.menu.select': 'Seleccionar…',
  'workbench.gitLog.menu.selectInTree': 'Seleccionar en el árbol…',
  'workbench.gitLog.menu.favorites': 'Favoritos',
  'workbench.gitLog.user.me': 'yo',
  'workbench.gitLog.date.last24h': 'Últimas 24 horas',
  'workbench.gitLog.date.last7d': 'Últimos 7 días',
  'workbench.gitLog.date.title': 'Filtrar por fecha',
  'workbench.gitLog.date.since': 'Desde',
  'workbench.gitLog.date.until': 'Hasta',
  'workbench.gitLog.paths.title': 'Filtrar por rutas',
  'workbench.gitLog.paths.hint': 'Una ruta relativa al repositorio por línea — una carpeta abarca todo su contenido.',
  'workbench.gitLog.modal.ok': 'Aceptar',
  'workbench.gitLog.modal.cancel': 'Cancelar',
  'workbench.gitLog.graphOptions': 'Opciones del grafo',
  'workbench.gitLog.sort.heading': 'Ordenar',
  'workbench.gitLog.sort.byDate': 'Por fecha de commit',
  'workbench.gitLog.sort.topo': 'Topológicamente',
  'workbench.gitLog.options.heading': 'Opciones',
  'workbench.gitLog.options.firstParent': 'Primer padre',
  'workbench.gitLog.options.noMerges': 'Sin merges',
  'workbench.gitLog.branchActions.heading': 'Acciones de rama',
  'workbench.gitLog.branchActions.collapseLinear': 'Plegar ramas lineales',
  'workbench.gitLog.branchActions.expandLinear': 'Desplegar ramas lineales',
  'workbench.gitLog.cherryPick': 'Cherry-pick',
  'workbench.gitLog.viewOptions': 'Opciones de vista',
  'workbench.gitLog.show.heading': 'Mostrar',
  'workbench.gitLog.show.compactRefs': 'Vista compacta de referencias',
  'workbench.gitLog.show.tagNames': 'Nombres de etiquetas',
  'workbench.gitLog.show.longEdges': 'Aristas largas',
  'workbench.gitLog.show.commitTimestamp': 'Marca de tiempo del commit',
  'workbench.gitLog.show.refsOnLeft': 'Referencias a la izquierda',
  'workbench.gitLog.show.columns': 'Columnas',
  'workbench.gitLog.highlight.heading': 'Resaltar',
  'workbench.gitLog.highlight.myCommits': 'Mis commits',
  'workbench.gitLog.highlight.mergeCommits': 'Commits de merge',
  'workbench.gitLog.highlight.currentBranch': 'Rama actual',
  'workbench.gitLog.highlight.notCherryPicked': 'Commits sin cherry-pick',
  'workbench.gitLog.goTo': 'Ir a hash/rama/etiqueta',
  'workbench.gitLog.goTo.placeholder': 'Hash, rama o etiqueta',
  'workbench.gitLog.goTo.notFound': 'No se encontró en el historial cargado.',
  'workbench.gitLog.details.showDiff': 'Mostrar diff',
  'workbench.gitLog.details.revertSelected': 'Revertir cambios seleccionados',
  'workbench.gitLog.details.groupBy': 'Agrupar por',
  'workbench.gitLog.details.directory': 'Directorio',
  'workbench.gitLog.details.layout': 'Diseño',
  'workbench.gitLog.details.showDetails': 'Mostrar detalles',
  'workbench.gitLog.details.showDiffPreview': 'Vista previa del diff',
  'workbench.gitLog.refresh': 'Actualizar',
  ...
  'workbench.gitLog.console.tab': 'Consola',
  'workbench.gitLog.console.show': 'Mostrar la consola Git',
  'workbench.gitLog.console.empty': 'Los comandos Git que la aplicación ejecute en este repositorio aparecerán aquí.',
  'workbench.gitLog.noMatches': 'Ningún commit coincide con los filtros',
  'workbench.gitLog.resetFilters': 'Restablecer filtros',
  'workbench.gitLog.selectCommit': 'Selecciona un commit para ver sus cambios',
  'workbench.gitLog.noneSelected': 'Ningún commit seleccionado',
  'workbench.gitLog.loadFailed': 'No se pudo cargar el historial: {detail}',
  'workbench.gitLog.authorLine': '{author} <{email}> el {date}',
  'workbench.gitLog.coAuthors': 'Coautoría de {authors}',
  'workbench.gitLog.filesHeading': 'Archivos modificados',
  'workbench.gitLog.filesCount': '{count} archivos',
  'workbench.gitLog.expandAll': 'Expandir todo',
  'workbench.gitLog.collapseAll': 'Contraer todo',
  'workbench.gitLog.date.yesterday': 'Ayer {time}',
  'workbench.gitLog.diff.title': 'Diff — {path}',
  'workbench.gitLog.diff.binary': 'Archivo binario: sin vista previa de texto.',
  'workbench.gitLog.diff.tooLarge': 'Archivo demasiado grande para la vista previa ({size} KB).',
  'workbench.gitLog.rail.hide': 'Ocultar ramas de Git',
  'workbench.gitLog.rail.show': 'Mostrar ramas de Git',
  'workbench.gitLog.rail.branchesStrip': 'Ramas',
  'workbench.gitLog.rail.newBranch': 'Nueva rama',
  'workbench.gitLog.rail.updateSelected': 'Actualizar selección',
  'workbench.gitLog.rail.deleteBranch': 'Eliminar rama',
  'workbench.gitLog.rail.compareWithCurrent': 'Comparar con la actual',
  'workbench.gitLog.rail.showMyBranches': 'Mostrar mis ramas',
  'workbench.gitLog.rail.fetch': 'Recuperar',
  'workbench.gitLog.rail.toggleFavorite': 'Marcar/desmarcar como favorita',
  'workbench.gitLog.rail.navigateToHead': 'Ir en el registro a la cabeza de la rama seleccionada',
  'workbench.gitLog.rail.paneSettings': 'Ajustes del panel de ramas',
  'workbench.gitLog.rail.singleClickHeading': 'Con un solo clic',
  'workbench.gitLog.rail.singleClickFilter': 'Actualizar el filtro de rama',
  'workbench.gitLog.rail.singleClickNavigate': 'Ir en el registro a la cabeza de la rama',
  'workbench.gitLog.rail.showTags': 'Mostrar etiquetas',
  'workbench.gitLog.rail.groupByDirectory': 'Agrupar por directorio',
  'workbench.gitLog.rail.expandAll': 'Expandir todo',
  'workbench.gitLog.rail.collapseAll': 'Contraer todo',
  'workbench.gitLog.createBranch.title': 'Crear rama desde {from}',
  'workbench.gitLog.createBranch.nameLabel': 'Nombre de la rama:',
  'workbench.gitLog.createBranch.checkout': 'Cambiar a la rama',
  'workbench.gitLog.createBranch.overwrite': 'Sobrescribir la rama existente',
  'workbench.gitLog.createBranch.create': 'Crear',
  'workbench.gitLog.createBranch.cancel': 'Cancelar',
  'workbench.gitLog.createBranch.exists': 'La rama {name} ya existe — marca Sobrescribir para restablecerla.',
  'workbench.gitLog.createBranch.failed': 'No se pudo crear la rama: {detail}',
  'workbench.gitLog.createBranch.checkedOut': 'Nueva rama {branch} creada desde {from} y activada',
  'workbench.gitLog.deleteBranch.deleted': 'Rama eliminada: {branch}',
  'workbench.gitLog.deleteBranch.restore': 'Restaurar',
  'workbench.gitLog.deleteBranch.failed': 'No se pudo eliminar la rama: {detail}',
  'workbench.gitLog.updateBranch.noUpstream': '{branch} no tiene rama remota configurada para actualizar.',
  'workbench.gitLog.updateBranch.failed': 'No se pudo actualizar {branch}: {detail}',
  'workbench.gitLog.fetch.noRemote': 'No hay remotos configurados.',
  'workbench.gitLog.fetch.failed': 'Error al recuperar: {detail}',
  'workbench.gitLog.compareTab': 'Comparar: {a} y {b}',
  'workbench.gitLog.compare.onlyIn': 'Commits que existen en {a} pero no en {b}',
  'workbench.gitLog.compare.containsAll': '{a} contiene todos los commits de {b}',
  'workbench.gitLog.compare.failed': 'No se pudo comparar: {detail}',
  ...
  'workbench.commitTool.oneDirectory': '1 directorio',
  'workbench.commitTool.directoriesCount': '{count} directorios',
  'workbench.commitTool.dirsAndFiles': '{dirs} y {files}',
  ...
  'workbench.commitTool.rollback': 'Revertir…',
  'workbench.commitTool.shelve': 'Apartar silenciosamente',
  'workbench.commitTool.show': 'Mostrar',
  'workbench.commitTool.ignoredFiles': 'Archivos ignorados',
  'workbench.commitTool.selectOpened': 'Seleccionar el archivo abierto en la vista de cambios',
  'workbench.commitTool.amend': 'Enmendar',
  'workbench.commitTool.historyTooltip': 'Historial de mensajes de commit',
  'workbench.commitTool.historyEmpty': 'Aún no hay mensajes confirmados',
  'workbench.commitTool.messagePlaceholder': 'Mensaje de commit',
  'workbench.commitTool.commit': 'Commit',
  'workbench.commitTool.commitAndPush': 'Commit y push…',
  'workbench.commitTool.optionsTooltip': 'Mostrar opciones de commit',
  'workbench.commitTool.options.gitSection': 'Git',
  'workbench.commitTool.options.signOff': 'Commit con sign-off',
  'workbench.commitTool.options.runGitHooks': 'Ejecutar hooks de Git',
  'workbench.commitTool.counter.modified': '{count} modificado(s)',
  'workbench.commitTool.counter.added': '{count} añadido(s)',
  'workbench.commitTool.counter.deleted': '{count} eliminado(s)',
  'workbench.commitTool.counter.unversioned': '{count} sin versionar',
  'workbench.commitTool.nothingToCommit': 'No hay cambios en los archivos seleccionados',
  'workbench.commitTool.committed': 'Commit {sha} creado',
  'workbench.commitTool.menu.commitFile': 'Commit del archivo…',
  'workbench.commitTool.menu.moveToChangelist': 'Mover a otra lista de cambios…',
  'workbench.commitTool.menu.showDiff': 'Mostrar diferencias',
  'workbench.commitTool.menu.showDiffNewTab': 'Mostrar diferencias en una pestaña nueva',
  'workbench.commitTool.menu.jumpToSource': 'Ir al código fuente',
  'workbench.commitTool.menu.delete': 'Eliminar…',
  'workbench.commitTool.menu.addToVcs': 'Añadir al VCS',
  'workbench.commitTool.menu.addToGitignore': 'Añadir a .gitignore',
  'workbench.commitTool.menu.excludeFile': '.git/info/exclude',
  'workbench.commitTool.menu.newChangelist': 'Nueva lista de cambios…',
  'workbench.commitTool.menu.editChangelist': 'Editar lista de cambios…',
  'workbench.commitTool.menu.createPatch': 'Crear parche a partir de los cambios locales…',
  'workbench.commitTool.menu.copyPatch': 'Copiar como parche al portapapeles',
  'workbench.commitTool.menu.shelveChanges': 'Archivar cambios…',
  'workbench.commitTool.menu.localHistory': 'Historial local',
  'workbench.commitTool.menu.localHistoryShow': 'Mostrar historial…',
  'workbench.commitTool.menu.showProjectHistory': 'Mostrar historial del proyecto…',
  'workbench.commitTool.menu.recentChanges': 'Cambios recientes',
  'workbench.commitTool.menu.putLabel': 'Añadir etiqueta…',
  'workbench.commitTool.menu.git': 'Git',
  'workbench.commitTool.menu.add': 'Añadir',
  'workbench.commitTool.menu.compareRevision': 'Comparar con revisión…',
  'workbench.commitTool.menu.compareBranch': 'Comparar con rama o etiqueta…',
  'workbench.commitTool.menu.showHistory': 'Mostrar historial',
  'workbench.commitTool.menu.showCurrentRevision': 'Mostrar revisión actual',
  'workbench.commitTool.menu.push': 'Push…',
  'workbench.commitTool.menu.pull': 'Pull…',
  'workbench.commitTool.menu.fetch': 'Recuperar',
  'workbench.commitTool.menu.merge': 'Fusionar…',
  'workbench.commitTool.menu.rebase': 'Rebasar…',
  'workbench.commitTool.menu.branches': 'Ramas…',
  'workbench.commitTool.menu.newBranch': 'Nueva rama…',
  'workbench.commitTool.menu.newTag': 'Nueva etiqueta…',
  'workbench.commitTool.menu.resetHead': 'Restablecer HEAD…',
  'workbench.commitTool.menu.stash': 'Guardar cambios en stash…',
  'workbench.commitTool.menu.unstash': 'Recuperar cambios del stash…',
  'workbench.commitTool.menu.github': 'GitHub',
  'workbench.commitTool.menu.manageRemotes': 'Gestionar remotos…',
  'workbench.commitTool.menu.clone': 'Clonar…',
  'workbench.commitTool.menu.comparePickerTitle': 'Comparar con rama o etiqueta',
  'workbench.commitTool.menu.comparePickerSearch': 'Buscar ramas y etiquetas',
  'workbench.commitTool.menu.comparePickerEmpty': 'Sin referencias coincidentes',
  'workbench.commitTool.menu.pullUpToDate': 'Ya está actualizado',
  ...
  'workbench.commitTool.errors.notARepo': 'Este espacio de trabajo no tiene repositorio Git',
  'workbench.commitTool.errors.gitUnavailable': 'Git no está disponible en esta máquina',
  'workbench.commitTool.errors.emptyMessage': 'Escribe un mensaje de commit',
  'workbench.commitTool.errors.noPaths': 'Selecciona al menos un archivo para confirmar',
  'workbench.commitTool.errors.amendUnborn': 'Todavía no hay ningún commit que enmendar',
  'workbench.commitTool.errors.amendMerge': 'Los commits de fusión no se pueden enmendar',
  'workbench.commitTool.errors.amendPushed':
    'HEAD ya está enviado a su upstream: enmendar reescribiría un historial publicado',
  'workbench.commitTool.errors.stageFailed': 'No se pudieron preparar los archivos seleccionados',
  'workbench.commitTool.errors.commitFailed': 'El commit falló',
  'workbench.commitTool.errors.pushFailed': 'El push falló',
  'workbench.gitLog.refs.search': 'Rama o etiqueta',
  'workbench.gitLog.refs.head': 'HEAD (rama actual)',
