...
export const workbenchEditorsMqtt = {
  ...
  'workbench.editors.mqtt.auth.usernameLabel': 'Username',
  'workbench.editors.mqtt.auth.usernamePlaceholder': 'Username or {{variable}}',
  'workbench.editors.mqtt.auth.passwordLabel': 'Password',
  'workbench.editors.mqtt.auth.passwordPlaceholder': 'Password or {{variable}}',
  ...
  // ── Session pane ────────────────────────────────────────────────────
  'workbench.editors.mqtt.session.title': 'Session',
  'workbench.editors.mqtt.session.emptyHint': 'Connect to start the session — messages appear here live.',
  ...
  'workbench.editors.mqtt.timeline.connected': 'Connected',
  'workbench.editors.mqtt.timeline.disconnected': 'Disconnected',
  'workbench.editors.mqtt.timeline.stopped': 'Stopped',
  'workbench.editors.mqtt.timeline.subscribed': 'Subscribed — {detail}',
  'workbench.editors.mqtt.timeline.unsubscribed': 'Unsubscribed — {detail}',
  ...
  'workbench.editors.mqtt.timeline.waiting': 'Waiting for messages…',
