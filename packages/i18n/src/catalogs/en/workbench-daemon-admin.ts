...
export const workbenchDaemonAdmin = {
  // ── Console shell ──────────────────────────────────────────────────
  'workbench.daemonAdmin.title': 'Server administration',
  ...
  'workbench.daemonAdmin.deniedDescription': 'Administering this server requires the daemon.admin capability.',
