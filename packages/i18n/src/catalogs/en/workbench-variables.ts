...
export const workbenchVariables = {
  ...
  'workbench.variables.table.kindSecretManager': 'Secret Manager',
  'workbench.variables.table.smProvider.onepassword': '1Password',
  'workbench.variables.table.smProvider.bitwarden': 'Bitwarden',
  'workbench.variables.table.smProvider.oskeychain': 'OS credential store',
  ...
  'workbench.variables.table.smField.provider': 'Provider',
  'workbench.variables.table.smField.vault': 'Vault',
  'workbench.variables.table.smField.item': 'Item',
  'workbench.variables.table.smField.field': 'Field',
  'workbench.variables.table.smField.account': 'Account',
  'workbench.variables.table.smField.secretId': 'Secret ID',
  'workbench.variables.table.smField.service': 'Service',
  'workbench.variables.table.smField.name': 'Name',
  'workbench.variables.table.smField.stage': 'Stage',
  'workbench.variables.table.smField.region': 'Region',
  'workbench.variables.table.smField.profile': 'Profile',
  'workbench.variables.table.smField.vaultUrl': 'Vault URL',
  'workbench.variables.table.smField.version': 'Version',
  'workbench.variables.table.smField.mount': 'Mount',
  'workbench.variables.table.smField.path': 'Path',
  ...
  'workbench.variables.vault.secretsCount':
    'SECRETS ({strings} string · {totps} TOTP · {certs} certificate · {refs} secret manager)',
