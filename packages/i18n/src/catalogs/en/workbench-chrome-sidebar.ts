...
export const workbenchChromeSidebar = {
  ...
  'workbench.sidebar.view.httpRules': 'Browser Interceptor',
  ...
  'workbench.sidebar.toast.itemsMoved': ({ count }, locale) =>
    plural(locale, Number(count), { one: '{count} item moved', other: '{count} items moved' }),
  'workbench.sidebar.toast.moveFailed': 'Move failed',
  ...
  'workbench.sidebar.menu.copyAs': 'Copy as',
  'workbench.sidebar.menu.copyAsCurl': 'cURL',
  'workbench.sidebar.menu.copyAsFetch': 'fetch',
  'workbench.sidebar.menu.convertToGraphql': 'Convert to GraphQL request',
