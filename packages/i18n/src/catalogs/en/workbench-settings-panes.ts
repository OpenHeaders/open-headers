...
export const workbenchSettingsPanes = {
  ...
  'workbench.settings.backendPane.placement.section': 'New workspaces',
  'workbench.settings.backendPane.placement.label': 'Where they go',
  'workbench.settings.backendPane.placement.description': 'Change it anytime. Existing workspaces stay where they are.',
  ...
  'workbench.settings.licensePane.detailsSection': 'License',
  ...
  'workbench.settings.systemProxy.previewSection': 'Route Preview',
  ...
  'workbench.settings.systemProxy.system.valuesLabel': 'System values',
  'workbench.settings.systemProxy.system.sourcedNote':
    'Read from this machine ({source}) — resolution still answers per URL.',
  'workbench.settings.systemProxy.system.unavailable': 'The system configuration could not be read: {message}',
  'workbench.settings.systemProxy.mode.manual': 'Manual',
  'workbench.settings.systemProxy.mode.manualDesc':
    'One proxy for everything — HTTP, HTTPS, or SOCKS5 by URL scheme — with vault credentials and a bypass list.',
  ...
  'workbench.settings.systemProxy.manual.urlPlaceholder': 'No proxy — direct connection',
  'workbench.settings.systemProxy.manual.urlExample': 'e.g. http://proxy.example:8080 or socks5://proxy.example:1080',
  'workbench.settings.systemProxy.manual.urlError':
    'Enter host:port or an http://, https://, or socks5:// proxy URL — SOCKS4 isn’t supported.',
  ...
  'workbench.settings.systemProxy.manual.credentialsEmpty': 'No string entries in this device’s vault yet.',
  'workbench.settings.systemProxy.manual.credentialsManage': 'Manage credentials in the vault',
  'workbench.settings.systemProxy.manual.bypass': 'Bypass list',
  'workbench.settings.systemProxy.manual.bypassPlaceholder': 'No bypass — every host uses the proxy',
  'workbench.settings.systemProxy.manual.bypassExample': 'e.g. localhost, .internal.example, 10.0.0.0/8',
  'workbench.settings.systemProxy.manual.bypassError':
    'Comma-separated entries only — no spaces inside an entry, no scheme.',
  'workbench.settings.systemProxy.manual.supported': 'Supported',
  'workbench.settings.systemProxy.pac.source': 'PAC',
  'workbench.settings.systemProxy.pac.sourcePlaceholder': 'No PAC URL — direct connection',
  'workbench.settings.systemProxy.pac.sourceExample': 'e.g. https://proxy.example/proxy.pac',
  'workbench.settings.systemProxy.pac.sourceError': 'Must be an http:// or https:// PAC URL.',
  'workbench.settings.systemProxy.pac.kindUrl': 'URL',
  'workbench.settings.systemProxy.pac.kindFile': 'File',
  'workbench.settings.systemProxy.pac.filePlaceholder': 'No PAC file — direct connection',
  'workbench.settings.systemProxy.pac.fileExample': 'e.g. /path/to/proxy.pac',
  'workbench.settings.systemProxy.pac.fileError': 'Must be an absolute file path.',
  ...
  'workbench.settings.gitPane.section.workingTree': 'Working tree',
  'workbench.settings.gitPane.section.branches': 'Branches',
  'workbench.settings.gitPane.section.commit': 'Commit',
  'workbench.settings.gitPane.section.history': 'History',
