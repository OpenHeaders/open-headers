...
export const workbenchSettings = {
  ...
  'workbench.settings.category.editor.sub.font': 'Font',
  'workbench.settings.category.editor.sub.indentation': 'Indentation',
  'workbench.settings.category.editor.sub.wrapping': 'Wrapping',
  'workbench.settings.category.editor.sub.display': 'Display',
  'workbench.settings.category.editor.sub.editing': 'Editing',
