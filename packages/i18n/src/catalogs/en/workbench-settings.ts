...
export const workbenchSettings = {
  ...
  'workbench.settings.category.mcpAccess.label': 'Access',
  ...
  'workbench.settings.category.diffViewer.label': 'Diff Viewer',
  ...
  'workbench.settings.category.gitAutomation.label': 'Automation',
  ...
  'workbench.settings.category.proxyOutbound.label': 'Outbound Requests',
  ...
  'workbench.settings.category.proxyTrust.label': 'HTTPS Trust',
