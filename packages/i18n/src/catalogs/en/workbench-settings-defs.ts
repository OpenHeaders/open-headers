...
export const workbenchSettingsDefs = {
  ...
  'workbench.settings.def.trafficMonitor.sessionRetentionGiB.label': 'Archive size budget (GiB)',
  ...
  'workbench.settings.def.trafficMonitor.railSide.option.right.label': 'Right',
  'workbench.settings.def.trafficMonitor.railSide.option.right.description':
    'Source list on the right, traffic views on the left.',
  ...
  'workbench.settings.def.requests.trustedRoots.label': 'Workspace Certificates',
  'workbench.settings.def.requests.trustedRoots.description':
    'Certificate authorities this workspace trusts in addition to the built-in roots, applied to every TLS connection the app’s runtime dials. Shared with every peer of the workspace — public material, never a secret.',
