...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.settings.exampleCaption': 'Example session',
  ...
  'workbench.editors.websocket.timeline.scriptFailed': '{hook} failed — {error}',
  'workbench.editors.websocket.timeline.scriptDropped': '{hook} dropped the message — {level}',
  'workbench.editors.websocket.timeline.scriptAttempt': 'attempt {attempt}',
  'workbench.editors.websocket.session.view.timeline': 'Timeline',
  'workbench.editors.websocket.session.view.scripts': 'Scripts',
  'workbench.editors.websocket.session.scripts.empty': 'No script has run in this session.',
  'workbench.editors.websocket.session.scripts.console': 'Console',
  'workbench.editors.websocket.session.scripts.tests': 'Tests',
  'workbench.editors.websocket.session.scripts.consoleEmpty': 'Nothing logged.',
  'workbench.editors.websocket.session.scripts.testsEmpty': 'No assertions registered.',
  'workbench.editors.websocket.session.scripts.attempt': 'attempt {attempt}',
  ...
  'workbench.editors.websocket.session.scripts.tagTitle': 'Session scripts',
  ...
  'workbench.editors.websocket.session.scripts.tagSummaryFailed': 'A hook failed — its last error is listed under it.',
  'workbench.editors.websocket.session.scripts.runs': '{count} runs',
  'workbench.editors.websocket.session.scripts.runsOne': '1 run',
