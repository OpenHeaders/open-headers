...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.timeline.showHexdump': 'Show Hexdump',
  'workbench.editors.websocket.timeline.showMessage': 'Show Message',
  'workbench.editors.websocket.timeline.viewerFormat': 'Message format',
