...
export const panel = {
  ...
  'panel.capture.collapsePlane': 'Collapse this section',
  ...
  'panel.tour.stepIndicator': 'Step {current} of {total}',
  'panel.tour.previous': 'Previous',
  'panel.tour.next': 'Next',
  'panel.tour.finish': 'Finish',
  'panel.tour.welcomeTitle': 'Unified DevTools Experience',
  'panel.tour.welcomeSubtitle': 'A network debugger with your rules built in.',
  'panel.tour.welcomeCapture': 'Capture',
  'panel.tour.welcomeCaptureHint': '— live requests with timings, headers, and sizes',
  'panel.tour.welcomeRules': 'Attribute',
  'panel.tour.welcomeRulesHint': '— see which rules fired on each request, and why',
  'panel.tour.welcomeState': 'Inspect',
  'panel.tour.welcomeStateHint': '— cookies, storage, and console beside the traffic',
  'panel.tour.networkTitle': 'The Network window',
  'panel.tour.networkSubtitle': 'Every request the inspected tab makes, live.',
  'panel.tour.networkFilters': 'Filter',
  'panel.tour.networkFiltersHint': '— by text, resource type, or the More filters presets',
  'panel.tour.networkToolbar': 'Control',
  'panel.tour.networkToolbarHint': '— Preserve log, throttling, and Disable cache up top',
  'panel.tour.networkExport': 'Export',
  'panel.tour.networkExportHint': '— save or copy the whole log as HAR',
  'panel.tour.storageTitle': 'The Storage window',
  'panel.tour.storageSubtitle': 'The inspected tab’s client-side state, in one place.',
  'panel.tour.storageAreas': 'Browse',
  'panel.tour.storageAreasHint': '— local and session storage, cookies, IndexedDB, caches',
  'panel.tour.storageEdit': 'Edit',
  'panel.tour.storageEditHint': '— open any entry as a document tab and change it in place',
  'panel.tour.inspectorTitle': 'Request detail',
  'panel.tour.inspectorSubtitle': 'Select a request to open it as a tab here.',
  ...
  'panel.tour.layoutToolsHint': '— Console, Search, Docs, and notifications live on the rails',
  'panel.tour.layoutDrag': 'Rearrange',
  'panel.tour.layoutDragHint': '— drag tool windows between docks; the layout menu resets',
  'panel.tour.debugTitle': 'Debug mode',
  'panel.tour.debugSubtitle': 'Off by default — flip it here when you need deeper capture.',
  'panel.tour.debugUnlocks': 'Unlocks',
  'panel.tour.debugUnlocksHint': '— response bodies, console, exact timings, and script-tier rules',
  'panel.tour.debugBanner': 'Heads up',
  'panel.tour.debugBannerHint': '— the browser shows a debugging banner on attached tabs while it’s on',
