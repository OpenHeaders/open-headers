...
export const web = {
  ...
  'web.consent.wouldSignIn': '{who} would like to sign in to this server',
  'web.consent.grantBody':
    'Once allowed, the device acts as you on this server and can do everything your account can.',
  ...
  'web.consent.decline': 'Decline',
  'web.consent.switchAccount': 'Switch account',
