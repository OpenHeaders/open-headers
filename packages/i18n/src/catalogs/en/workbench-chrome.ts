...
export const workbenchChrome = {
  ...
  'workbench.tabbar.createRule': 'Create Rule',
  ...
  'workbench.shell.commandPalette.cmd.openTrustedRoots': 'Open Trusted Certificates',
  ...
  'workbench.shell.topbar.layout.bottomLayout': 'Bottom Panel Layout',
  ...
  'workbench.shell.topbar.layout.splitColumns': 'Side by Side',
  'workbench.shell.topbar.layout.splitRows': 'Stacked',
  ...
  'workbench.shell.empty.createRequestDesc': 'HTTP, gRPC, WebSocket, and more',
  ...
  'workbench.shell.tabLabel.newMqttRequest': 'New MQTT Request',
  'workbench.shell.tabLabel.newGraphqlRequest': 'New GraphQL Request',
  ...
  'workbench.commitTool.menu.commitFile': 'Commit File…',
  'workbench.commitTool.menu.moveToChangelist': 'Move to Another Changelist…',
  'workbench.commitTool.menu.showDiff': 'Show Diff',
  'workbench.commitTool.menu.showDiffNewTab': 'Show Diff in a New Tab',
  'workbench.commitTool.menu.jumpToSource': 'Jump to Source',
  'workbench.commitTool.menu.delete': 'Delete…',
  'workbench.commitTool.menu.addToVcs': 'Add to VCS',
  'workbench.commitTool.menu.addToGitignore': 'Add to .gitignore',
  'workbench.commitTool.menu.excludeFile': '.git/info/exclude',
  'workbench.commitTool.menu.newChangelist': 'New Changelist…',
  'workbench.commitTool.menu.editChangelist': 'Edit Changelist…',
  'workbench.commitTool.menu.createPatch': 'Create Patch from Local Changes…',
  'workbench.commitTool.menu.copyPatch': 'Copy as Patch to Clipboard',
  'workbench.commitTool.menu.shelveChanges': 'Shelve Changes…',
  'workbench.commitTool.menu.localHistory': 'Local History',
  'workbench.commitTool.menu.localHistoryShow': 'Show History…',
  'workbench.commitTool.menu.showProjectHistory': 'Show Project History…',
  'workbench.commitTool.menu.recentChanges': 'Recent Changes',
  'workbench.commitTool.menu.putLabel': 'Put Label…',
  'workbench.commitTool.menu.git': 'Git',
  'workbench.commitTool.menu.add': 'Add',
  'workbench.commitTool.menu.compareRevision': 'Compare with Revision…',
  'workbench.commitTool.menu.compareBranch': 'Compare with Branch or Tag…',
  'workbench.commitTool.menu.showHistory': 'Show History',
  'workbench.commitTool.menu.showCurrentRevision': 'Show Current Revision',
  'workbench.commitTool.menu.push': 'Push…',
  'workbench.commitTool.menu.pull': 'Pull…',
  'workbench.commitTool.menu.fetch': 'Fetch',
  'workbench.commitTool.menu.merge': 'Merge…',
  'workbench.commitTool.menu.rebase': 'Rebase…',
  'workbench.commitTool.menu.branches': 'Branches…',
  'workbench.commitTool.menu.newBranch': 'New Branch…',
  'workbench.commitTool.menu.newTag': 'New Tag…',
  'workbench.commitTool.menu.resetHead': 'Reset HEAD…',
  'workbench.commitTool.menu.stash': 'Stash Changes…',
  'workbench.commitTool.menu.unstash': 'Unstash Changes…',
  'workbench.commitTool.menu.github': 'GitHub',
  'workbench.commitTool.menu.manageRemotes': 'Manage Remotes…',
  'workbench.commitTool.menu.clone': 'Clone…',
  'workbench.commitTool.menu.comparePickerTitle': 'Compare with Branch or Tag',
  'workbench.commitTool.menu.comparePickerSearch': 'Search branches and tags',
  'workbench.commitTool.menu.comparePickerEmpty': 'No matching refs',
