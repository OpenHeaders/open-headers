...
export const workbenchChrome = {
  ...
  'workbench.gitLog.console.show': 'Show Git console',
  'workbench.gitLog.console.empty': 'Git commands the app runs in this repo will appear here.',
  'workbench.gitLog.filterPlaceholder': 'Text or hash',
  'workbench.gitLog.filter.regex': 'Regex',
  'workbench.gitLog.filter.matchCase': 'Match Case',
  'workbench.gitLog.chip.branch': 'Branch',
  'workbench.gitLog.chip.tag': 'Tag',
  'workbench.gitLog.chip.user': 'User',
  'workbench.gitLog.chip.date': 'Date',
  'workbench.gitLog.chip.paths': 'Paths',
  'workbench.gitLog.chip.pathsCount': '{count} paths',
  'workbench.gitLog.menu.select': 'Select…',
  'workbench.gitLog.menu.selectInTree': 'Select in Tree…',
  'workbench.gitLog.menu.favorites': 'Favorites',
  'workbench.gitLog.user.me': 'me',
  'workbench.gitLog.date.last24h': 'Last 24 hours',
  'workbench.gitLog.date.last7d': 'Last 7 days',
  'workbench.gitLog.date.title': 'Filter by Date',
  'workbench.gitLog.date.since': 'Since',
  'workbench.gitLog.date.until': 'Until',
  'workbench.gitLog.paths.title': 'Filter by Paths',
  'workbench.gitLog.paths.hint': 'One repository-relative path per line — a folder scopes everything beneath it.',
  'workbench.gitLog.modal.ok': 'OK',
  'workbench.gitLog.modal.cancel': 'Cancel',
  'workbench.gitLog.graphOptions': 'Graph Options',
  'workbench.gitLog.sort.heading': 'Sort',
  'workbench.gitLog.sort.byDate': 'By Commit Date',
  'workbench.gitLog.sort.topo': 'Topologically',
  'workbench.gitLog.options.heading': 'Options',
  'workbench.gitLog.options.firstParent': 'First Parent',
  'workbench.gitLog.options.noMerges': 'No Merges',
  'workbench.gitLog.branchActions.heading': 'Branch Actions',
  'workbench.gitLog.branchActions.collapseLinear': 'Collapse Linear Branches',
  'workbench.gitLog.branchActions.expandLinear': 'Expand Linear Branches',
  'workbench.gitLog.cherryPick': 'Cherry-Pick',
  'workbench.gitLog.viewOptions': 'View Options',
  'workbench.gitLog.show.heading': 'Show',
  'workbench.gitLog.show.compactRefs': 'Compact References View',
  'workbench.gitLog.show.tagNames': 'Tag Names',
  'workbench.gitLog.show.longEdges': 'Long Edges',
  'workbench.gitLog.show.commitTimestamp': 'Commit Timestamp',
  'workbench.gitLog.show.refsOnLeft': 'References on the Left',
  'workbench.gitLog.show.columns': 'Columns',
  'workbench.gitLog.highlight.heading': 'Highlight',
  'workbench.gitLog.highlight.myCommits': 'My Commits',
  'workbench.gitLog.highlight.mergeCommits': 'Merge Commits',
  'workbench.gitLog.highlight.currentBranch': 'Current Branch',
  'workbench.gitLog.highlight.notCherryPicked': 'Not Cherry-Picked Commits',
  'workbench.gitLog.goTo': 'Go To Hash/Branch/Tag',
  'workbench.gitLog.goTo.placeholder': 'Hash, branch or tag',
  'workbench.gitLog.goTo.notFound': 'Not found in the loaded log.',
  'workbench.gitLog.details.showDiff': 'Show Diff',
  'workbench.gitLog.details.revertSelected': 'Revert Selected Changes',
  'workbench.gitLog.details.groupBy': 'Group By',
  'workbench.gitLog.details.directory': 'Directory',
  'workbench.gitLog.details.layout': 'Layout',
  'workbench.gitLog.details.showDetails': 'Show Details',
  'workbench.gitLog.details.showDiffPreview': 'Show Diff Preview',
  ...
  'workbench.gitLog.noMatches': 'No commits matching filters',
  'workbench.gitLog.resetFilters': 'Reset filters',
  'workbench.gitLog.selectCommit': 'Select a commit to view its changes',
  'workbench.gitLog.noneSelected': 'No commit selected',
  ...
  'workbench.gitLog.filesCount': '{count} files',
  'workbench.gitLog.expandAll': 'Expand all',
  'workbench.gitLog.collapseAll': 'Collapse all',
  'workbench.gitLog.date.yesterday': 'Yesterday {time}',
  ...
  'workbench.gitLog.refs.search': 'Branch or tag',
  'workbench.gitLog.refs.head': 'HEAD (Current Branch)',
  ...
  'workbench.gitLog.rail.hide': 'Hide Git Branches',
  'workbench.gitLog.rail.show': 'Show Git Branches',
  'workbench.gitLog.rail.branchesStrip': 'Branches',
  'workbench.gitLog.rail.newBranch': 'New Branch',
  'workbench.gitLog.rail.updateSelected': 'Update Selected',
  'workbench.gitLog.rail.deleteBranch': 'Delete Branch',
  'workbench.gitLog.rail.compareWithCurrent': 'Compare with Current',
  'workbench.gitLog.rail.showMyBranches': 'Show My Branches',
  'workbench.gitLog.rail.fetch': 'Fetch',
  'workbench.gitLog.rail.toggleFavorite': 'Mark/Unmark As Favorite',
  'workbench.gitLog.rail.navigateToHead': 'Navigate Log to Selected Branch Head',
  'workbench.gitLog.rail.paneSettings': 'Branches Pane Settings',
  'workbench.gitLog.rail.singleClickHeading': 'On Single Click',
  'workbench.gitLog.rail.singleClickFilter': 'Update Branch Filter',
  'workbench.gitLog.rail.singleClickNavigate': 'Navigate Log to Branch Head',
  'workbench.gitLog.rail.showTags': 'Show Tags',
  'workbench.gitLog.rail.groupByDirectory': 'Group By Directory',
  'workbench.gitLog.rail.expandAll': 'Expand All',
  'workbench.gitLog.rail.collapseAll': 'Collapse All',
  'workbench.gitLog.createBranch.title': 'Create Branch from {from}',
  'workbench.gitLog.createBranch.nameLabel': 'Branch Name:',
  'workbench.gitLog.createBranch.checkout': 'Checkout branch',
  'workbench.gitLog.createBranch.overwrite': 'Overwrite existing branch',
  'workbench.gitLog.createBranch.create': 'Create',
  'workbench.gitLog.createBranch.cancel': 'Cancel',
  'workbench.gitLog.createBranch.exists': 'Branch {name} already exists — check Overwrite to reset it.',
  'workbench.gitLog.createBranch.failed': 'Could not create branch: {detail}',
  'workbench.gitLog.createBranch.checkedOut': 'Checked out new branch {branch} from {from}',
  'workbench.gitLog.deleteBranch.deleted': 'Deleted Branch: {branch}',
  'workbench.gitLog.deleteBranch.restore': 'Restore',
  'workbench.gitLog.deleteBranch.failed': 'Could not delete branch: {detail}',
  'workbench.gitLog.updateBranch.noUpstream': '{branch} has no upstream to update from.',
  'workbench.gitLog.updateBranch.failed': 'Could not update {branch}: {detail}',
  'workbench.gitLog.fetch.noRemote': 'No remotes configured.',
  'workbench.gitLog.fetch.failed': 'Fetch failed: {detail}',
  'workbench.gitLog.compareTab': 'Compare: {a} and {b}',
  'workbench.gitLog.compare.onlyIn': "Commits that exist in {a} but don't exist in {b}",
  'workbench.gitLog.compare.containsAll': '{a} contains all commits from {b}',
  'workbench.gitLog.compare.failed': 'Could not compare: {detail}',
  ...
  'workbench.commitTool.oneDirectory': '1 directory',
  'workbench.commitTool.directoriesCount': '{count} directories',
  'workbench.commitTool.dirsAndFiles': '{dirs} and {files}',
  ...
  'workbench.commitTool.rollback': 'Rollback…',
  'workbench.commitTool.shelve': 'Shelve Silently',
  'workbench.commitTool.show': 'Show',
  'workbench.commitTool.ignoredFiles': 'Ignored Files',
  'workbench.commitTool.selectOpened': 'Select Opened File in Changes View',
  'workbench.commitTool.amend': 'Amend',
  'workbench.commitTool.historyTooltip': 'Commit Message History',
  'workbench.commitTool.historyEmpty': 'No committed messages yet',
  'workbench.commitTool.messagePlaceholder': 'Commit Message',
  'workbench.commitTool.commit': 'Commit',
  'workbench.commitTool.commitAndPush': 'Commit and Push…',
  'workbench.commitTool.optionsTooltip': 'Show Commit Options',
  'workbench.commitTool.options.gitSection': 'Git',
  'workbench.commitTool.options.signOff': 'Sign-off commit',
  'workbench.commitTool.options.runGitHooks': 'Run Git hooks',
  'workbench.commitTool.counter.modified': '{count} modified',
  'workbench.commitTool.counter.added': '{count} added',
  'workbench.commitTool.counter.deleted': '{count} deleted',
  'workbench.commitTool.counter.unversioned': '{count} unversioned',
  'workbench.commitTool.nothingToCommit': 'No changes in the selected files',
  'workbench.commitTool.committed': 'Committed {sha}',
  'workbench.commitTool.pushed': 'Pushed',
  'workbench.commitTool.nothingToPush': 'Nothing to push',
  'workbench.commitTool.errors.notARepo': 'This workspace has no Git repository',
  'workbench.commitTool.errors.gitUnavailable': 'Git is not available on this machine',
  'workbench.commitTool.errors.emptyMessage': 'Enter a commit message',
  'workbench.commitTool.errors.noPaths': 'Select at least one file to commit',
  'workbench.commitTool.errors.amendUnborn': 'There is no commit to amend yet',
  'workbench.commitTool.errors.amendMerge': 'Merge commits cannot be amended',
  'workbench.commitTool.errors.amendPushed':
    'HEAD is already pushed to its upstream — amending would rewrite published history',
  'workbench.commitTool.errors.stageFailed': 'Could not stage the selected files',
  'workbench.commitTool.errors.commitFailed': 'Commit failed',
  'workbench.commitTool.errors.pushFailed': 'Push failed',
