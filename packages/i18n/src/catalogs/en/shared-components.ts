...
export const sharedComponents = {
  ...
  'shared.templateInput.completion.secretManagerDoc':
    '**Secret manager reference** — `{reference}`. Resolved from the manager at send time; the value is never stored.',
  ...
  'shared.codeEditor.find': 'Find',
  'shared.codeEditor.replace': 'Replace',
  'shared.codeEditor.format': 'Format',
  ...
  'shared.peerExecute.localDisabled':
    'Sending from this device’s browsers is turned off in the desktop app. Enable "Allow this device’s browsers to send requests" under Backup and Sync › Your devices.',
