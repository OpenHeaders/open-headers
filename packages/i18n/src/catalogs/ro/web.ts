...
export const web = {
  ...
  'web.consent.wouldSignIn': '{who} dorește să se conecteze la acest server',
  'web.consent.grantBody':
    'Odată autorizat, dispozitivul acționează în numele dvs. pe acest server și poate face tot ce poate face contul dvs.',
  ...
  'web.consent.decline': 'Refuzare',
  'web.consent.switchAccount': 'Schimbare cont',
