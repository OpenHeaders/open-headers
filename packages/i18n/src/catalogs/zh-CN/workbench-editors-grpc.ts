...
export const workbenchEditorsGrpc = {
  ...
  'workbench.editors.grpc.tab.scripts': '脚本',
  ...
  'workbench.editors.grpc.auth.helpOwn':
    '每次调用生成一次，作为 authorization（或密钥自身名称的）metadata 随调用发送——查询位置绝不会随 gRPC 调用发送。同名的显式 metadata 行优先。',
  ...
  'workbench.editors.grpc.timeline.receivedMetadata': '已接收{metadata}。',
  'workbench.editors.grpc.timeline.receivedMetadataLink': '元数据',
  'workbench.editors.grpc.timeline.noMetadataReceived': '未接收元数据。',
  ...
  'workbench.editors.grpc.timeline.scriptFailed': '{hook} 失败 — {error}',
  'workbench.editors.grpc.response.tab.scripts': '脚本',
  'workbench.editors.grpc.scripts.empty': '本次调用中没有脚本运行。',
  'workbench.editors.grpc.scripts.console': '控制台',
  'workbench.editors.grpc.scripts.tests': '测试',
  'workbench.editors.grpc.scripts.consoleEmpty': '没有日志输出。',
  'workbench.editors.grpc.scripts.testsEmpty': '未注册任何断言。',
  'workbench.editors.grpc.scripts.attempt': '第 {attempt} 次尝试',
  'workbench.editors.grpc.scripts.atMessage': '消息 {index}',
  'workbench.editors.grpc.scripts.tag': '脚本 · {count}',
  'workbench.editors.grpc.scripts.tagTitle': '调用脚本',
  'workbench.editors.grpc.scripts.tagSummary': '本次调用中运行的钩子，以及参与的各层级。',
  'workbench.editors.grpc.scripts.tagSummaryFailed': '有钩子失败 — 其最近一次错误列在其下方。',
  'workbench.editors.grpc.scripts.runs': '{count} 次运行',
