...
export const workbenchServerAdmin = {
  ...
  'workbench.serverAdmin.audit.capSsoAdmin': 'SSO 管理员（声明）',
  'workbench.serverAdmin.audit.capDeviceLogin': '设备登录（已批准）',
  ...
  'workbench.serverAdmin.audit.eventSsoAdmin': 'SSO 管理员',
  'workbench.serverAdmin.audit.eventDeviceLogin': '设备登录',
