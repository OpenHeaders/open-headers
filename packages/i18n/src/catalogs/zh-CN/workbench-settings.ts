...
export const workbenchSettings = {
  ...
  'workbench.settings.category.editor.sub.font': '字体',
  'workbench.settings.category.editor.sub.indentation': '缩进',
  'workbench.settings.category.editor.sub.wrapping': '换行',
  'workbench.settings.category.editor.sub.display': '显示',
  'workbench.settings.category.editor.sub.editing': '编辑',
