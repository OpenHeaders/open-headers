...
export const workbenchSettings = {
  ...
  'workbench.settings.category.mcpClients.label': 'AI · MCP 服务器 · 客户端',
  'workbench.settings.category.mcpClients.navLabel': '客户端',
  'workbench.settings.category.mcpClients.description': '把 oh 命令行和 MCP 客户端连接到此应用。',
  'workbench.settings.category.mcpClients.sub.command-line': '命令行',
  'workbench.settings.category.mcpClients.sub.configuration': '配置',
  'workbench.settings.category.appearanceBehavior.label': '外观与行为',
  'workbench.settings.category.appearanceBehavior.description': '应用的外观与行为：区域设置、主题和工作台外壳。',
  'workbench.settings.category.general.label': '外观与行为 · 常规',
  'workbench.settings.category.general.navLabel': '常规',
  'workbench.settings.category.general.description': '应用级行为、启动和区域设置。',
  'workbench.settings.category.general.sub.locale': '语言',
  'workbench.settings.category.general.sub.behavior': '行为',
  'workbench.settings.category.general.sub.settings': '设置',
  'workbench.settings.category.general.sub.privacy': '隐私',
  'workbench.settings.category.appearance.label': '外观与行为 · 外观',
  'workbench.settings.category.appearance.navLabel': '外观',
  ...
  'workbench.settings.category.workspaceLayout.label': '外观与行为 · 工作区布局',
  'workbench.settings.category.workspaceLayout.navLabel': '工作区布局',
  ...
  'workbench.settings.category.editor.label': '编辑器',
  'workbench.settings.category.editor.description': '每个编辑器标签页中的代码与差异界面。',
  'workbench.settings.category.codeEditor.label': '编辑器 · 代码编辑器',
  'workbench.settings.category.codeEditor.navLabel': '代码编辑器',
  'workbench.settings.category.codeEditor.description': '代码编辑界面的字体、缩进和视图选项。',
  'workbench.settings.category.codeEditor.sub.font': '字体',
  'workbench.settings.category.codeEditor.sub.indentation': '缩进',
  'workbench.settings.category.codeEditor.sub.wrapping': '换行',
  'workbench.settings.category.codeEditor.sub.display': '显示',
  ...
  'workbench.settings.category.rulesEngine.sub.drafting': '规则草稿',
  'workbench.settings.category.rulesEngine.sub.display': '显示',
  ...
  'workbench.settings.category.git.label': '版本控制 · Git',
  ...
  'workbench.settings.category.gitFolder.label': 'Git · 文件夹',
  'workbench.settings.category.gitFolder.navLabel': '文件夹',
  'workbench.settings.category.gitFolder.description': '此工作区绑定到的磁盘文件夹。',
  'workbench.settings.category.gitFolder.sub.binding': '绑定',
  'workbench.settings.category.gitFolder.sub.requirements': '要求',
  'workbench.settings.category.gitAutomation.label': 'Git · 自动化',
  'workbench.settings.category.gitAutomation.navLabel': '自动化',
  ...
  'workbench.settings.category.application.description': '应用本身：数据、更新、许可证和版本。',
  'workbench.settings.category.data.label': '应用程序 · 数据',
  'workbench.settings.category.data.navLabel': '数据',
  ...
  'workbench.settings.category.license.label': '应用程序 · 许可证',
  'workbench.settings.category.license.navLabel': '许可证',
  'workbench.settings.category.license.description':
    '今天 Open Headers 的一切在每个档位都包含——付费方案覆盖的是团队席位。免费档每个服务器最多准入 6 位' + '活跃用户。',
  'workbench.settings.category.updates.label': '应用程序 · 更新',
  'workbench.settings.category.updates.navLabel': '更新',
  ...
  'workbench.settings.category.about.label': '应用程序 · 关于',
  'workbench.settings.category.about.navLabel': '关于',
