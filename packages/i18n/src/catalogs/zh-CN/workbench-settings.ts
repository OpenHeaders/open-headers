...
export const workbenchSettings = {
  ...
  'workbench.settings.category.gitRepository.label': 'Git · 仓库',
  'workbench.settings.category.gitRepository.navLabel': '仓库',
  'workbench.settings.category.gitRepository.description': '对已绑定仓库进行拉取、推送、分支、提交和浏览历史。',
  'workbench.settings.category.gitRepository.sub.working-tree': '工作树',
  'workbench.settings.category.gitRepository.sub.branches': '分支',
  'workbench.settings.category.gitRepository.sub.commit': '提交',
  'workbench.settings.category.gitRepository.sub.history': '历史',
