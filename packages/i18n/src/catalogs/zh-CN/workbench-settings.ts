...
export const workbenchSettings = {
  ...
  'workbench.settings.category.backendConnections.label': '连接',
  'workbench.settings.category.backendConnections.description': '始终在线的本地引擎，以及此主机连接的后端。',
  'workbench.settings.category.backendServer.label': '服务器',
  ...
  'workbench.settings.category.backendPairing.label': '桌面配对',
  ...
  'workbench.settings.category.backendReliability.label': '可靠性',
