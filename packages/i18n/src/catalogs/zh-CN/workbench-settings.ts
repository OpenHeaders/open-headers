...
export const workbenchSettings = {
  ...
  'workbench.settings.category.backendConnections.label': '同步',
  'workbench.settings.category.backendConnections.description': '你的工作区与哪些地方同步，以及你如何登录它们。',
  'workbench.settings.category.backendServer.label': '你的设备',
  'workbench.settings.category.backendServer.description': '让你的其他设备与本机同步，并查看你已配对的设备。',
  ...
  'workbench.settings.category.backendPairing.label': '桌面应用',
  'workbench.settings.category.backendPairing.description': '此浏览器如何连接本机上的桌面应用，以及应用可以查看什么。',
  ...
  'workbench.settings.category.backendReliability.label': '高级',
  'workbench.settings.category.backendReliability.description': '每条同步连接的重连、状态与离线回退。',
  ...
  'workbench.settings.category.mcp.description':
    ...
    '默认全部关闭。',
  'workbench.settings.category.mcpAccess.label': '访问',
  ...
  'workbench.settings.category.mcpClients.label': '客户端',
  ...
  'workbench.settings.category.devpanelLayout.label': '布局',
  ...
  'workbench.settings.category.codeEditor.label': '代码编辑器',
  ...
  'workbench.settings.category.diffViewer.label': '差异查看器',
  ...
  'workbench.settings.category.gitFolder.label': '文件夹',
  ...
  'workbench.settings.category.gitAutomation.label': '自动化',
  ...
  'workbench.settings.category.proxyOutbound.label': '出站请求',
  'workbench.settings.category.proxyOutbound.description':
    '此设备的出站代理——请求、WebSocket 会话和 gRPC 调用如何抵达网络。',
  'workbench.settings.category.proxyTrust.label': 'HTTPS 信任',
