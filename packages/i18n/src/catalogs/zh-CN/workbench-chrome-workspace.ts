...
export const workbenchChromeWorkspace = {
  ...
  'workbench.workspace.members.title': '“{name}”的成员',
  'workbench.workspace.members.openAria': '管理成员',
  'workbench.workspace.members.loadFailed': '成员加载失败',
  'workbench.workspace.members.updateFailed': '成员更新失败',
  'workbench.workspace.members.operatorTag': '服务器运维者',
  'workbench.workspace.members.managedTag': '托管',
  'workbench.workspace.members.managedTooltip': '此授权由身份提供方管理。',
  'workbench.workspace.members.removeConfirm': '将 {name} 从此工作区移除？',
  'workbench.workspace.members.removeOk': '移除',
  'workbench.workspace.members.removeAria': '移除成员',
  'workbench.workspace.members.removedToast': '已移除 {name}',
  'workbench.workspace.members.updatedToast': '已更新 {name}',
  'workbench.workspace.members.addedToast': '已添加 {name}',
  'workbench.workspace.members.addPlaceholder': '添加人员或服务账号…',
  'workbench.workspace.members.addButton': '添加',
  'workbench.workspace.members.noneToAdd': '此服务器上的所有人都已拥有访问权限。',
  'workbench.workspace.members.readOnlyHint': '只有工作区所有者可以更改成员。',
  'workbench.workspace.members.visibilityLabel': '访问权限',
  'workbench.workspace.members.visibilityPrivate': '私有',
  'workbench.workspace.members.visibilityInternal': '内部',
  'workbench.workspace.members.visibilityPrivateHint': '只有受邀成员可以看到此工作区。',
  'workbench.workspace.members.visibilityInternalHint': '此服务器的所有成员都可以查看此工作区。只有你添加的成员才能编辑。',
  'workbench.workspace.members.visibilityUpdatedToast': '工作区访问权限已更新',
