...
export const workbenchChromeWorkspace = {
  ...
  'workbench.workspace.members.visibilityInternalHint':
    '此服务器的所有成员都可以查看此工作区。只有你添加的成员才能编辑。',
  'workbench.workspace.members.visibilityUpdatedToast': '工作区访问权限已更新',
  'workbench.workspace.members.visibilityPublic': '公开',
  'workbench.workspace.members.visibilityPublicHint':
    '任何拥有链接的人都可以查看此工作区的只读共享快照。只有你添加的成员才能编辑。',
  'workbench.workspace.publicShare.heading': '公开链接',
  'workbench.workspace.publicShare.loadFailed': '无法加载公开共享状态',
  'workbench.workspace.publicShare.disabledHint':
    '此服务器已禁用公开工作区。操作员可在 daemon.json 中通过 publicWorkspaces 启用。',
  'workbench.workspace.publicShare.notShared': '尚未共享快照 — 共享后链接即可访问。',
  'workbench.workspace.publicShare.sharedAt': '快照已于 {when} 共享',
  'workbench.workspace.publicShare.shareButton': '公开共享…',
  'workbench.workspace.publicShare.updateButton': '更新公开副本…',
  'workbench.workspace.publicShare.stopButton': '停止共享',
  'workbench.workspace.publicShare.stopConfirm': '停止共享此工作区？公开链接将立即失效。',
  'workbench.workspace.publicShare.stopOk': '停止共享',
  'workbench.workspace.publicShare.stoppedToast': '公开链接已移除',
  'workbench.workspace.publicShare.sharedToast': '公开快照已共享',
  'workbench.workspace.publicShare.copyLink': '复制链接',
  'workbench.workspace.publicShare.copiedToast': '链接已复制',
  'workbench.workspace.publicShare.reviewTitle': '公开共享“{name}”',
  ...
  'workbench.workspace.publicShare.reviewVariables': '变量（{count}）',
  'workbench.workspace.publicShare.reviewNoVariables': '没有变量。',
  'workbench.workspace.publicShare.reviewValueHidden': '已隐藏',
  'workbench.workspace.publicShare.confirmShare': '共享快照',
  'workbench.workspace.publicShare.previewFailed': '无法准备快照预览',
  'workbench.workspace.publicShare.shareFailed': '无法共享快照',
  'workbench.workspace.publicShare.scope.workspace': '工作区',
  'workbench.workspace.publicShare.scope.environment': '环境',
  'workbench.workspace.publicShare.scope.collection': '集合',
  'workbench.workspace.publicShare.cat.requests': '{count} 个请求',
  'workbench.workspace.publicShare.cat.collections': '{count} 个集合',
  'workbench.workspace.publicShare.cat.folders': '{count} 个文件夹',
  'workbench.workspace.publicShare.cat.rules': '{count} 条规则',
  'workbench.workspace.publicShare.cat.environments': '{count} 个环境',
  'workbench.workspace.publicShare.cat.examples': '{count} 个响应示例',
  'workbench.workspace.publicShare.cat.specs': '{count} 个 API 规范',
  'workbench.workspace.publicShare.cat.scripts': '{count} 个脚本包',
  'workbench.workspace.publicShare.cat.templates': '{count} 个模板',
  'workbench.workspace.publicShare.cat.live': '{count} 个实时工作流',
  'workbench.workspace.publicShare.cat.files': '{count} 个文件',
  'workbench.workspace.publicView.bannerTag': '公开快照',
  'workbench.workspace.publicView.banner': '“{name}”的只读公开副本。在此处所做的更改不会保存。',
  'workbench.workspace.publicView.loadFailed': '此公开工作区链接不可用。',
