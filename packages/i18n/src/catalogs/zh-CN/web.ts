...
export const web = {
  'web.gate.titleSignIn': '登录此守护进程',
  'web.gate.titlePair': '与此守护进程配对',
  'web.gate.introSso': '使用 {provider} 登录，或在下方粘贴配对 token。',
  'web.gate.introPassword': '使用守护进程管理员为你设置的邮箱和密码登录，或在下方粘贴配对 token。',
  'web.gate.introTokenPrefix': '此 OpenHeaders 守护进程需要配对 token。在运行它的机器上使用',
  ...
  'web.gate.errorTokenRejected': '守护进程拒绝了此 token。请检查后重试。',
  'web.gate.errorTokenOffline': '守护进程没有响应。请检查它是否在运行，然后重试。',
  'web.gate.errorPasswordRefused': '登录失败。请检查邮箱和密码后重试。',
  'web.gate.errorSessionRefused': '守护进程未接受该会话。请重试。',
  ...
  'web.oidcError.unknownUser': '已登录，但此守护进程上没有对应你邮箱的用户。请守护进程管理员添加你。',
  'web.oidcError.userDeactivated': '已登录，但你在此守护进程上的用户已被停用。请联系守护进程管理员。',
  ...
  'web.oidcError.seatLimitReached':
    '已登录，但此守护进程没有空闲席位可分配给新用户。请联系守护进程管理员——或者现在就用你自己的个人席位进入。',
  'web.oidcError.personalSeatsDisabled': '此守护进程已禁用个人席位。请向守护进程管理员咨询席位。',
  ...
  'web.oidcError.personalLicenseNoIdentity': '你的登录没有携带可与个人席位匹配的邮箱。请联系守护进程管理员。',
  ...
  'web.insecure.httpsPrefix':
    '通过 HTTPS——将守护进程置于 TLS 反向代理之后（参见守护进程 README 中的“Behind a reverse proxy”），然后打开',
  'web.insecure.httpsSuffix': '.',
  'web.insecure.loopbackPrefix': '在守护进程所在的机器上访问',
