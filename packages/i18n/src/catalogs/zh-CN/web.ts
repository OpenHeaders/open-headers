...
export const web = {
  ...
  'web.overlay.takingYouBack': '正在返回{client}…',
  ...
  'web.consent.wouldSignIn': '{who}想要登录此服务器',
  'web.consent.grantBody': '允许后，该设备将以你的身份使用此服务器，并可执行你的账户能执行的一切操作。',
  ...
  'web.consent.decline': '拒绝',
  'web.consent.switchAccount': '切换账户',
  'web.consent.approvedTitle': '设备已批准',
  'web.consent.approvedBody': '该设备已以你的身份登录。你可以关闭此标签页。',
  'web.consent.deniedTitle': '登录已拒绝',
  'web.consent.deniedBody': '该设备不会登录。你可以关闭此标签页。',
  'web.consent.expiredTitle': '登录请求已过期',
  'web.consent.expiredBody': '时限已过。请从设备重新开始登录。',
  'web.consent.notFoundTitle': '未找到登录请求',
  'web.consent.notFoundBody': '此请求已过期或从未发出。请从设备重新开始登录。',
  'web.consent.offlineTitle': '登录不可用',
  'web.consent.continue': '继续前往 Workbench',
