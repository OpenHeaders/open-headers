...
export const workbenchEditorsMqtt = {
  ...
  'workbench.editors.mqtt.topics.filterLabel': '主题',
  'workbench.editors.mqtt.topics.filterPlaceholder': '主题，例如 sensors/+/temperature',
  ...
  'workbench.editors.mqtt.settings.alpnPlaceholder': '无（默认）',
  'workbench.editors.mqtt.settings.alpnExample': '例如 mqtt',
  ...
  'workbench.editors.mqtt.session.tab.scripts': '脚本',
  'workbench.editors.mqtt.tab.scripts': '脚本',
  'workbench.editors.mqtt.timeline.script': '{hook} — {levels}',
  'workbench.editors.mqtt.timeline.scriptFailed': '{hook} 失败 — {error}',
  'workbench.editors.mqtt.timeline.scriptDropped': '{hook} 丢弃了消息 — {level}',
  'workbench.editors.mqtt.timeline.scriptAttempt': '第 {attempt} 次尝试',
  'workbench.editors.mqtt.session.scripts.empty': '本会话中没有运行过脚本。',
  'workbench.editors.mqtt.session.scripts.console': '控制台',
  'workbench.editors.mqtt.session.scripts.tests': '测试',
  'workbench.editors.mqtt.session.scripts.consoleEmpty': '没有日志。',
  'workbench.editors.mqtt.session.scripts.testsEmpty': '没有注册断言。',
  'workbench.editors.mqtt.session.scripts.attempt': '第 {attempt} 次尝试',
  'workbench.editors.mqtt.session.scripts.atMessage': '事件 {index}',
  'workbench.editors.mqtt.session.scripts.tag': '脚本 · {count}',
  'workbench.editors.mqtt.session.scripts.tagTitle': '会话脚本',
  'workbench.editors.mqtt.session.scripts.tagSummary': '本会话中运行的钩子，以及参与的层级。',
  'workbench.editors.mqtt.session.scripts.tagSummaryFailed': '有钩子失败 — 其最后一次错误列在下方。',
  'workbench.editors.mqtt.session.scripts.runs': '{count} 次运行',
