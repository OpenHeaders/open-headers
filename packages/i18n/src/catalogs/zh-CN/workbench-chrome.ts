...
export const workbenchChrome = {
  ...
  'workbench.trafficMonitor.observeArmed': '观察中——已连接的 AI 智能体可持续读取，直到停止或闲置过期。点击查看选项。',
  'workbench.trafficMonitor.observeCapturing': '观察中 + 正在把会话保存到磁盘——仅脱敏记录。点击查看选项。',
  'workbench.trafficMonitor.observeAria': '此来源的 AI 智能体观察选项',
  'workbench.trafficMonitor.observeMenuArm': '仅观察',
  'workbench.trafficMonitor.observeMenuArmHint':
    '把此来源的流量以内存方式流式传输到桌面应用——授权期间已连接的 AI 智能体可读取',
  'workbench.trafficMonitor.observeMenuArmSave': '观察 + 保存会话',
  'workbench.trafficMonitor.observeMenuArmSaveHint': '同时把脱敏后的流量录制到磁盘上有上限的会话文件',
  'workbench.trafficMonitor.observeMenuSave': '同时把会话保存到磁盘',
  'workbench.trafficMonitor.observeMenuSaveHint': '开始录制此已授权来源——脱敏记录，有上限的文件',
  'workbench.trafficMonitor.observeMenuStop': '停止观察',
  'workbench.trafficMonitor.observeMenuStopSave': '停止观察并保留会话',
  'workbench.trafficMonitor.observeMenuStopSaveHint': '结束录制并保留会话文件',
  ...
  'workbench.trafficMonitor.sessionsEmpty': '本次运行的磁盘录制会显示在这里',
  'workbench.trafficMonitor.sessionDetail': '{records} 条记录 · {size}',
  'workbench.trafficMonitor.sessionStop': '正在录制——点击停止',
  'workbench.trafficMonitor.sessionStopAria': '停止此捕获会话',
  'workbench.trafficMonitor.sessionReveal': '在文件夹中显示',
  'workbench.trafficMonitor.sessionRevealAria': '在文件管理器中显示会话文件夹',
  'workbench.trafficMonitor.sessionEndStopped': '已停止',
  'workbench.trafficMonitor.sessionEndSizeBound': '大小上限',
  'workbench.trafficMonitor.sessionEndDurationBound': '时长上限',
  'workbench.trafficMonitor.sessionEndSourceDisarmed': '来源已解除',
  'workbench.trafficMonitor.sessionEndWriteError': '写入错误',
  'workbench.trafficMonitor.sessionEndCrashed': '已中断',
