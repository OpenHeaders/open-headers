...
export const workbenchChrome = {
  ...
  'workbench.shell.commandPalette.cmd.openTrustedRoots': '打开受信任的证书',
  ...
  'workbench.shell.tabLabel.newMqttRequest': '新 MQTT 请求',
  'workbench.shell.tabLabel.newGraphqlRequest': '新 GraphQL 请求',
  ...
  'workbench.gitLog.filterPlaceholder': '文本或哈希',
  'workbench.gitLog.filter.regex': '正则表达式',
  'workbench.gitLog.filter.matchCase': '区分大小写',
  'workbench.gitLog.chip.branch': '分支',
  'workbench.gitLog.chip.tag': '标签',
  'workbench.gitLog.chip.user': '用户',
  'workbench.gitLog.chip.date': '日期',
  'workbench.gitLog.chip.paths': '路径',
  'workbench.gitLog.chip.pathsCount': '{count} 个路径',
  'workbench.gitLog.menu.select': '选择…',
  'workbench.gitLog.menu.selectInTree': '在树中选择…',
  'workbench.gitLog.menu.favorites': '收藏',
  'workbench.gitLog.user.me': '我',
  'workbench.gitLog.date.last24h': '最近 24 小时',
  'workbench.gitLog.date.last7d': '最近 7 天',
  'workbench.gitLog.date.title': '按日期筛选',
  'workbench.gitLog.date.since': '起始',
  'workbench.gitLog.date.until': '截止',
  'workbench.gitLog.paths.title': '按路径筛选',
  'workbench.gitLog.paths.hint': '每行一个仓库相对路径 — 文件夹涵盖其下所有内容。',
  'workbench.gitLog.modal.ok': '确定',
  'workbench.gitLog.modal.cancel': '取消',
  'workbench.gitLog.graphOptions': '图形选项',
  'workbench.gitLog.sort.heading': '排序',
  'workbench.gitLog.sort.byDate': '按提交日期',
  'workbench.gitLog.sort.topo': '按拓扑顺序',
  'workbench.gitLog.options.heading': '选项',
  'workbench.gitLog.options.firstParent': '仅第一父提交',
  'workbench.gitLog.options.noMerges': '不含合并提交',
  'workbench.gitLog.branchActions.heading': '分支操作',
  'workbench.gitLog.branchActions.collapseLinear': '折叠线性分支',
  'workbench.gitLog.branchActions.expandLinear': '展开线性分支',
  'workbench.gitLog.cherryPick': '拣选（Cherry-Pick）',
  'workbench.gitLog.viewOptions': '视图选项',
  'workbench.gitLog.show.heading': '显示',
  'workbench.gitLog.show.compactRefs': '紧凑引用视图',
  'workbench.gitLog.show.tagNames': '标签名称',
  'workbench.gitLog.show.longEdges': '长边',
  'workbench.gitLog.show.commitTimestamp': '提交时间戳',
  'workbench.gitLog.show.refsOnLeft': '引用靠左显示',
  'workbench.gitLog.show.columns': '列',
  'workbench.gitLog.highlight.heading': '高亮',
  'workbench.gitLog.highlight.myCommits': '我的提交',
  'workbench.gitLog.highlight.mergeCommits': '合并提交',
  'workbench.gitLog.highlight.currentBranch': '当前分支',
  'workbench.gitLog.highlight.notCherryPicked': '未拣选的提交',
  'workbench.gitLog.goTo': '跳转到哈希/分支/标签',
  'workbench.gitLog.goTo.placeholder': '哈希、分支或标签',
  'workbench.gitLog.goTo.notFound': '在已加载的日志中未找到。',
  'workbench.gitLog.details.showDiff': '显示差异',
  'workbench.gitLog.details.revertSelected': '还原所选更改',
  'workbench.gitLog.details.groupBy': '分组方式',
  'workbench.gitLog.details.directory': '目录',
  'workbench.gitLog.details.layout': '布局',
  'workbench.gitLog.details.showDetails': '显示详情',
  'workbench.gitLog.details.showDiffPreview': '显示差异预览',
  'workbench.gitLog.refresh': '刷新',
  'workbench.gitLog.empty': '还没有提交',
  'workbench.gitLog.logTab': 'Log：{branch}',
  'workbench.gitLog.logTabAll': 'Log',
  'workbench.gitLog.closeTab': '关闭标签页',
  'workbench.gitLog.newLogTab': '新建 Log 标签页',
  'workbench.gitLog.tabMenu': '标签页选项',
  'workbench.gitLog.console.tab': '控制台',
  'workbench.gitLog.console.show': '显示 Git 控制台',
  'workbench.gitLog.console.empty': '应用在此仓库中执行的 Git 命令将显示在这里。',
  'workbench.gitLog.noMatches': '没有符合筛选条件的提交',
  'workbench.gitLog.resetFilters': '重置筛选',
  'workbench.gitLog.selectCommit': '选择一个提交以查看其更改',
  'workbench.gitLog.noneSelected': '未选择提交',
  ...
  'workbench.gitLog.filesCount': '{count} 个文件',
  'workbench.gitLog.expandAll': '全部展开',
  'workbench.gitLog.collapseAll': '全部折叠',
  'workbench.gitLog.date.yesterday': '昨天 {time}',
  ...
  'workbench.gitLog.rail.hide': '隐藏 Git 分支',
  'workbench.gitLog.rail.show': '显示 Git 分支',
  'workbench.gitLog.rail.branchesStrip': '分支',
  'workbench.gitLog.rail.newBranch': '新建分支',
  'workbench.gitLog.rail.updateSelected': '更新所选分支',
  'workbench.gitLog.rail.deleteBranch': '删除分支',
  'workbench.gitLog.rail.compareWithCurrent': '与当前分支比较',
  'workbench.gitLog.rail.showMyBranches': '显示我的分支',
  'workbench.gitLog.rail.fetch': '抓取',
  'workbench.gitLog.rail.toggleFavorite': '标记/取消标记为收藏',
  'workbench.gitLog.rail.navigateToHead': '在日志中定位到所选分支头',
  'workbench.gitLog.rail.paneSettings': '分支面板设置',
  'workbench.gitLog.rail.singleClickHeading': '单击时',
  'workbench.gitLog.rail.singleClickFilter': '更新分支筛选',
  'workbench.gitLog.rail.singleClickNavigate': '在日志中定位到分支头',
  'workbench.gitLog.rail.showTags': '显示标签',
  'workbench.gitLog.rail.groupByDirectory': '按目录分组',
  'workbench.gitLog.rail.expandAll': '全部展开',
  'workbench.gitLog.rail.collapseAll': '全部折叠',
  'workbench.gitLog.createBranch.title': '从 {from} 创建分支',
  'workbench.gitLog.createBranch.nameLabel': '分支名称：',
  'workbench.gitLog.createBranch.checkout': '检出分支',
  'workbench.gitLog.createBranch.overwrite': '覆盖现有分支',
  'workbench.gitLog.createBranch.create': '创建',
  'workbench.gitLog.createBranch.cancel': '取消',
  'workbench.gitLog.createBranch.exists': '分支 {name} 已存在 — 勾选“覆盖”以重置它。',
  'workbench.gitLog.createBranch.failed': '无法创建分支：{detail}',
  'workbench.gitLog.createBranch.checkedOut': '已从 {from} 检出新分支 {branch}',
  'workbench.gitLog.deleteBranch.deleted': '已删除分支：{branch}',
  'workbench.gitLog.deleteBranch.restore': '恢复',
  'workbench.gitLog.deleteBranch.failed': '无法删除分支：{detail}',
  'workbench.gitLog.updateBranch.noUpstream': '{branch} 没有可用于更新的上游分支。',
  'workbench.gitLog.updateBranch.failed': '无法更新 {branch}：{detail}',
  'workbench.gitLog.fetch.noRemote': '未配置远程仓库。',
  'workbench.gitLog.fetch.failed': '抓取失败：{detail}',
  'workbench.gitLog.compareTab': '比较：{a} 与 {b}',
  'workbench.gitLog.compare.onlyIn': '存在于 {a} 但不存在于 {b} 的提交',
  'workbench.gitLog.compare.containsAll': '{a} 包含 {b} 的全部提交',
  ...
  'workbench.commitTool.oneDirectory': '1 个目录',
  'workbench.commitTool.directoriesCount': '{count} 个目录',
  'workbench.commitTool.dirsAndFiles': '{dirs}和{files}',
  ...
  'workbench.commitTool.rollback': '回滚…',
  'workbench.commitTool.shelve': '静默搁置',
  'workbench.commitTool.show': '显示',
  'workbench.commitTool.ignoredFiles': '已忽略的文件',
  'workbench.commitTool.selectOpened': '在更改视图中选中已打开的文件',
  'workbench.commitTool.amend': '修正提交',
  'workbench.commitTool.historyTooltip': '提交信息历史',
  'workbench.commitTool.historyEmpty': '还没有已提交的信息',
  'workbench.commitTool.messagePlaceholder': '提交信息',
  'workbench.commitTool.commit': '提交',
  'workbench.commitTool.commitAndPush': '提交并推送…',
  'workbench.commitTool.optionsTooltip': '显示提交选项',
  'workbench.commitTool.options.gitSection': 'Git',
  'workbench.commitTool.options.signOff': '签署提交（Sign-off）',
  'workbench.commitTool.options.runGitHooks': '运行 Git 钩子',
  'workbench.commitTool.counter.modified': '{count} 个已修改',
  'workbench.commitTool.counter.added': '{count} 个已添加',
  'workbench.commitTool.counter.deleted': '{count} 个已删除',
  'workbench.commitTool.counter.unversioned': '{count} 个未版本控制',
  'workbench.commitTool.nothingToCommit': '所选文件中没有更改',
  'workbench.commitTool.committed': '已提交 {sha}',
  'workbench.commitTool.menu.commitFile': '提交文件…',
  'workbench.commitTool.menu.moveToChangelist': '移动到其他更改列表…',
  'workbench.commitTool.menu.showDiff': '显示差异',
  'workbench.commitTool.menu.showDiffNewTab': '在新标签页中显示差异',
  'workbench.commitTool.menu.jumpToSource': '跳转到源文件',
  'workbench.commitTool.menu.delete': '删除…',
  'workbench.commitTool.menu.addToVcs': '添加到版本控制',
  'workbench.commitTool.menu.addToGitignore': '添加到 .gitignore',
  'workbench.commitTool.menu.excludeFile': '.git/info/exclude',
  'workbench.commitTool.menu.newChangelist': '新建更改列表…',
  'workbench.commitTool.menu.editChangelist': '编辑更改列表…',
  'workbench.commitTool.menu.createPatch': '从本地更改创建补丁…',
  'workbench.commitTool.menu.copyPatch': '以补丁形式复制到剪贴板',
  'workbench.commitTool.menu.shelveChanges': '搁置更改…',
  'workbench.commitTool.menu.localHistory': '本地历史',
  'workbench.commitTool.menu.localHistoryShow': '显示历史…',
  'workbench.commitTool.menu.showProjectHistory': '显示项目历史…',
  'workbench.commitTool.menu.recentChanges': '最近的更改',
  'workbench.commitTool.menu.putLabel': '添加标签…',
  'workbench.commitTool.menu.git': 'Git',
  'workbench.commitTool.menu.add': '添加',
  'workbench.commitTool.menu.compareRevision': '与修订版本比较…',
  'workbench.commitTool.menu.compareBranch': '与分支或标签比较…',
  'workbench.commitTool.menu.showHistory': '显示历史',
  'workbench.commitTool.menu.showCurrentRevision': '显示当前修订版本',
  'workbench.commitTool.menu.push': '推送…',
  'workbench.commitTool.menu.pull': '拉取…',
  'workbench.commitTool.menu.fetch': '抓取',
  'workbench.commitTool.menu.merge': '合并…',
  'workbench.commitTool.menu.rebase': '变基…',
  'workbench.commitTool.menu.branches': '分支…',
  'workbench.commitTool.menu.newBranch': '新建分支…',
  'workbench.commitTool.menu.newTag': '新建标签…',
  'workbench.commitTool.menu.resetHead': '重置 HEAD…',
  'workbench.commitTool.menu.stash': '贮藏更改…',
  'workbench.commitTool.menu.unstash': '取消贮藏…',
  'workbench.commitTool.menu.github': 'GitHub',
  'workbench.commitTool.menu.manageRemotes': '管理远程仓库…',
  'workbench.commitTool.menu.clone': '克隆…',
  'workbench.commitTool.menu.comparePickerTitle': '与分支或标签比较',
  'workbench.commitTool.menu.comparePickerSearch': '搜索分支和标签',
  'workbench.commitTool.menu.comparePickerEmpty': '没有匹配的引用',
  ...
  'workbench.commitTool.menu.stopIgnoring': '停止忽略',
  'workbench.commitTool.ignoreSourceGlobal': '全局',
  'workbench.commitTool.menu.fetchDone': '抓取完成',
  'workbench.commitTool.pushed': '已推送',
  'workbench.commitTool.nothingToPush': '没有可推送的内容',
  'workbench.commitTool.errors.notARepo': '此工作区没有 Git 仓库',
  'workbench.commitTool.errors.gitUnavailable': '本机没有可用的 Git',
  'workbench.commitTool.errors.emptyMessage': '请输入提交信息',
  'workbench.commitTool.errors.noPaths': '请至少选择一个要提交的文件',
  'workbench.commitTool.errors.amendUnborn': '还没有可修正的提交',
  'workbench.commitTool.errors.amendMerge': '合并提交不能被修正',
  'workbench.commitTool.errors.amendPushed': 'HEAD 已推送到其上游——修正会改写已发布的历史',
  'workbench.commitTool.errors.stageFailed': '无法暂存所选文件',
  'workbench.commitTool.errors.commitFailed': '提交失败',
  'workbench.commitTool.errors.pushFailed': '推送失败',
  'workbench.gitLog.refs.search': '分支或标签',
  'workbench.gitLog.refs.head': 'HEAD（当前分支）',
  ...
  'workbench.trafficMonitor.captureAria': '此来源的捕获选项',
  'workbench.trafficMonitor.captureMenuStart': '开始捕获',
  'workbench.trafficMonitor.captureMenuStartHint':
    '保留此来源的近期流量：已连接的 AI 智能体可读取（敏感值已掩码），开启“保存会话”还会将其录制到磁盘。在这里查看实时视图从不需要捕获。',
  'workbench.trafficMonitor.captureAdvanced': '高级',
  'workbench.trafficMonitor.captureDebugOptionHint':
    '通过浏览器调试器获得完整保真度——响应正文与精确的标头。浏览器会显示调试横幅。',
  'workbench.trafficMonitor.captureSaveOption': '保存会话',
  'workbench.trafficMonitor.captureSaveOptionHint': '把捕获录制到本机的加密会话归档中',
  'workbench.trafficMonitor.captureMenuStop': '停止捕获',
  'workbench.trafficMonitor.captureMenuStopRecordingHint': '结束录制并保留会话',
  'workbench.trafficMonitor.sessionsTitle': '会话',
  ...
  'workbench.trafficSessions.deleteGroupTitle': '删除“{name}”？',
  'workbench.trafficSessions.deleteGroupBody': '其中的 {count} 个会话以及仅它们引用的录制数据将从磁盘中删除。',

  // ── 会话回放标签页（C6） ────────────────────────────────────────────
  'workbench.sessionReplay.empty': '此会话未录制任何请求',
  'workbench.sessionReplay.emptyHint': '来源已被捕获，但录制期间没有流量经过',
