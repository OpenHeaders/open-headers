...
export const workbenchChrome = {
  ...
  'workbench.trafficMonitor.observeArm': '授权智能体观察——授权期间，已连接的智能体可读取此来源的流量',
  'workbench.trafficMonitor.observeArmed': '已授权智能体观察——智能体可持续读取，直到取消授权或闲置过期',
  ...
  'workbench.trafficMonitor.captureRow': '正在把此来源捕获到磁盘——仅脱敏记录；点击停止',
  'workbench.trafficMonitor.captureStart': '录制到磁盘——把此来源的脱敏流量写入有上限的本地文件',
  'workbench.trafficMonitor.captureAria': '切换此来源的磁盘捕获',
