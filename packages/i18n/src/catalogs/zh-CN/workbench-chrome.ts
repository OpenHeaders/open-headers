...
export const workbenchChrome = {
  ...
  'workbench.trafficMonitor.observeAdvanced': '高级',
  'workbench.trafficMonitor.observeDebugOptionHint':
    '通过浏览器调试器获得完整保真度——响应正文与精确的标头。浏览器会显示调试横幅。',
  'workbench.trafficMonitor.observeSaveOption': '保存会话',
  'workbench.trafficMonitor.observeSaveOptionHint': '把观察录制到本机的加密会话归档中',
  'workbench.trafficMonitor.observeMenuStop': '停止观察',
  'workbench.trafficMonitor.observeMenuStopRecordingHint': '结束录制并保留会话',
  'workbench.trafficMonitor.sessionsTitle': '会话',
  'workbench.trafficMonitor.sessionsEmpty': '正在录制的会话会显示在这里',
