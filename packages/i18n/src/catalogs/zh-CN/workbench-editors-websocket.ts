...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.timeline.showHexdump': '显示十六进制转储',
  'workbench.editors.websocket.timeline.showMessage': '显示消息',
  'workbench.editors.websocket.timeline.viewerFormat': '消息格式',
