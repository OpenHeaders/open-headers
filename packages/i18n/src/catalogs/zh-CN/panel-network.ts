...
export const panelNetwork = {
  ...
  'panel.rowAnnotations.interceptionJoined.label': '已合并流量拦截',
  'panel.rowAnnotations.interceptionJoined.detail':
    '此交换也被流量拦截（本地代理）捕获。该捕获提供的线路上实际标头、实测大小和套接字耗时会补全浏览器捕获自身未记录的部分。',
  'panel.rowAnnotations.interceptionSeen.label': '曾在浏览器标签页中出现',
  'panel.rowAnnotations.interceptionSeen.detail':
    '此拦截交换也在浏览器标签页 {tab} 中被观察到——两行是同一请求，从两侧分别见证。',
  'panel.rowAnnotations.interceptionSeen.unknownTab': '受观察的标签页',
  'panel.rowAnnotations.interceptionSeen.jump': '在标签页来源中显示',
