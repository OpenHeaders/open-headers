...
export const workbenchEditorsRequest = {
  ...
  'workbench.editors.request.settings.overridesSource': '覆盖 {source}（{value}）',
  'workbench.editors.request.settings.settingChainTitle': '此设置的定义位置',
  'workbench.editors.request.settings.settingChainSummary': '设置此项的每一层级，由外到内——最内层的值生效。',
  'workbench.editors.request.settings.settingChainHeading': '层级',
  'workbench.editors.request.settings.thisRequest': '此请求',
  'workbench.editors.request.settings.thisFolder': '此文件夹',
