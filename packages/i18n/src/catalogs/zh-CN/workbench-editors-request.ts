...
export const workbenchEditorsRequest = {
  ...
  'workbench.editors.request.response.meta.tlsCipher': '加密套件',
  'workbench.editors.request.response.meta.tlsCertificate': '证书',
  'workbench.editors.request.response.meta.tlsIssuer': '颁发者',
  ...
  'workbench.editors.request.response.meta.tagTrusted': '受信任的证书',
  'workbench.editors.request.response.meta.trustedTitle': '已应用受信任的证书',
