...
export const workbenchSettingsPanes = {
  ...
  'workbench.settings.backendPane.wizard.title.desktop': '连接桌面端应用',
  'workbench.settings.backendPane.wizard.title.server': '登录服务器',
  'workbench.settings.backendPane.wizard.step.address': '地址',
  'workbench.settings.backendPane.wizard.step.signIn': '登录',
  'workbench.settings.backendPane.wizard.connect': '连接',
  'workbench.settings.backendPane.wizard.checkAgain': '再次检查',
  'workbench.settings.backendPane.wizard.checking': '正在检查 {host}…',
  'workbench.settings.backendPane.wizard.verdict.needsPairing': '{host} 要求此设备登录。',
  'workbench.settings.backendPane.wizard.verdict.signedIn': '已登录到 {name}。',
  'workbench.settings.backendPane.wizard.verdict.signedInUnnamed': '已登录。',
  'workbench.settings.backendPane.wizard.verdict.signedInAs': '已以 {person} 身份登录到 {name}。',
  'workbench.settings.backendPane.wizard.verdict.signedInAsUnnamed': '已以 {person} 身份登录。',
  'workbench.settings.backendPane.wizard.signIn.primary': '在 {host} 上登录',
  'workbench.settings.backendPane.wizard.signIn.intro':
    '{host} 的页面会在你的浏览器中打开。在那里用你自己的账户登录并批准此设备——这里不需要输入任何内容。',
  ...
  'workbench.settings.backendPane.wizard.signIn.noLogin':
    '没有人能从浏览器登录 {host}，因此只能使用其管理员提供的配对码或 token。',
  'workbench.settings.backendPane.wizard.signIn.secondary': '有管理员提供的配对码或 token？',
  ...
  'workbench.settings.backendPane.wizard.signIn.fail.offline': '{host} 没有任何响应。它是否在该地址上运行？',
  ...
  'workbench.settings.backendPane.placement.section': '新工作区',
  'workbench.settings.backendPane.placement.label': '归入位置',
  'workbench.settings.backendPane.placement.description': '随时可以更改。现有工作区保持原位。',
  ...
  'workbench.settings.backendPane.field.url.label': '服务器地址',
  'workbench.settings.backendPane.field.url.description':
    '管理员给你的地址或 URL。这台电脑或你的网络用 `http` 或 `ws`，远程服务器用 `https` 或 `wss`。',
  'workbench.settings.backendPane.field.url.invalid': '请输入主机、主机:端口或 URL。',
  ...
  'workbench.settings.licensePane.detailsSection': '许可证',
  ...
  'workbench.settings.systemProxy.mode.infoSummary': '此设备如何为每个请求、WebSocket 会话与 gRPC 调用决定路由。',
  'workbench.settings.systemProxy.mode.infoHeading': '模式',
  ...
  'workbench.settings.systemProxy.mode.manualDesc':
    '在此配置一个代理用于所有流量——HTTP、HTTPS 或 SOCKS5 由 URL 协议决定——含 vault 凭据与绕过列表。',
  ...
  'workbench.settings.systemProxy.manual.urlPlaceholder': '无代理——直接连接',
  'workbench.settings.systemProxy.manual.urlExample': '例如 http://proxy.example:8080 或 socks5://proxy.example:1080',
  'workbench.settings.systemProxy.manual.urlError':
    '请输入 host:port，或 http://、https://、socks5:// 代理 URL——不支持 SOCKS4。',
  ...
  'workbench.settings.systemProxy.manual.bypassError': '仅限逗号分隔的条目——条目内不能有空格，不能带协议前缀。',
  'workbench.settings.systemProxy.manual.supported': '支持',
  'workbench.settings.systemProxy.pac.source': 'PAC',
  'workbench.settings.systemProxy.pac.sourcePlaceholder': '无 PAC URL——直接连接',
  'workbench.settings.systemProxy.pac.sourceExample': '例如 https://proxy.example/proxy.pac',
  'workbench.settings.systemProxy.pac.sourceError': '必须是 http:// 或 https:// 的 PAC URL。',
  'workbench.settings.systemProxy.pac.kindUrl': 'URL',
  'workbench.settings.systemProxy.pac.kindFile': '文件',
  'workbench.settings.systemProxy.pac.filePlaceholder': '无 PAC 文件——直接连接',
  'workbench.settings.systemProxy.pac.fileExample': '例如 /path/to/proxy.pac',
  'workbench.settings.systemProxy.pac.fileError': '必须是绝对文件路径。',
  ...
  'workbench.settings.gitPane.needsRepo': '此页面需要已绑定且带有仓库的文件夹——请先在此绑定：',
  'workbench.settings.gitPane.section.workingTree': '工作树',
  'workbench.settings.gitPane.section.branches': '分支',
  'workbench.settings.gitPane.section.commit': '提交',
  'workbench.settings.gitPane.section.history': '历史',
