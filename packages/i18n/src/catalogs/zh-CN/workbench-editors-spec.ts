...
export const workbenchEditorsSpec = {
  ...
  'workbench.editors.spec.outline.groups.types': '类型',
  'workbench.editors.spec.outline.groups.interfaces': '接口',
  'workbench.editors.spec.outline.groups.unions': '联合类型',
  'workbench.editors.spec.outline.groups.inputs': '输入类型',
  'workbench.editors.spec.outline.groups.scalars': '标量',
  'workbench.editors.spec.outline.groups.directives': '指令',
