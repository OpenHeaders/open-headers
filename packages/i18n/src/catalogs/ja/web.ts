...
export const web = {
  ...
  'web.overlay.takingYouBack': '{client}へ戻っています…',
  ...
  'web.consent.title': 'このデバイスを承認しますか？',
  ...
  'web.consent.asksAs': '{who}が {name} としてこのサーバーへのサインインを求めています。',
  'web.consent.asksAsYou': '{who}があなたとしてこのサーバーへのサインインを求めています。',
  'web.consent.code': 'コード {code}：デバイスに表示されているコードと一致することを確認してください。',
  'web.consent.expires': '約 {minutes} 分で期限切れ',
  'web.consent.allow': '許可',
  'web.consent.notMe': '自分ではない',
  'web.consent.approvedTitle': 'デバイスを承認しました',
  'web.consent.approvedBody': 'デバイスはあなたとしてサインインしました。このタブは閉じて構いません。',
  'web.consent.deniedTitle': 'サインインを拒否しました',
  'web.consent.deniedBody': 'そのデバイスはサインインされません。このタブは閉じて構いません。',
  'web.consent.expiredTitle': 'サインイン要求の期限切れ',
  'web.consent.expiredBody': '有効期間が過ぎました。デバイスからサインインをやり直してください。',
  'web.consent.notFoundTitle': 'サインイン要求が見つかりません',
  'web.consent.notFoundBody': 'この要求は期限切れか、発行されていません。デバイスからサインインをやり直してください。',
  'web.consent.offlineTitle': 'サインインを利用できません',
  'web.consent.continue': 'Workbench へ進む',
