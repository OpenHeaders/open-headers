...
export const sharedComponents = {
  ...
  'shared.templateInput.completion.secretManagerDoc':
    '**Référence de gestionnaire de secrets** — `{reference}`. Résolue depuis le gestionnaire au moment ' +
    "de l'envoi ; la valeur n'est jamais stockée.",
  ...
  'shared.dock.slot.bottomTop': 'Bas supérieur',
  'shared.dock.slot.bottomBottom': 'Bas inférieur',
  ...
  'shared.peerExecute.localDisabled':
    ...
    '« Autoriser les navigateurs de cet appareil à envoyer des requêtes » sous Connectivité › Backend › Serveur.',
  'shared.peerExecute.remoteDisabled':
    ...
    'appareils connectés à envoyer des requêtes » dans Connectivité › Backend › Serveur sur cette machine.',
  ...
  'shared.desktopTeaser.git.title': 'Historique Git',
  'shared.desktopTeaser.git.body':
    'Parcourez la chronologie des commits de votre espace de travail, avec le détail par commit et les diffs de fichiers.',
  'shared.desktopTeaser.commit.title': 'Commit',
  'shared.desktopTeaser.commit.body':
    'Passez en revue et validez les modifications de votre espace de travail — arborescence de fichiers cochable, ' +
    'diffs par fichier et zone de message de commit.',
