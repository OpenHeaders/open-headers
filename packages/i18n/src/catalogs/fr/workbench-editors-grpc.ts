...
export const workbenchEditorsGrpc = {
  ...
  'workbench.editors.grpc.auth.inheritUnsupported': '{type} — de {source} — ne peut pas s’appliquer à un appel gRPC.',
  'workbench.editors.grpc.auth.helpOwn':
    'Émis à chaque invocation et envoyé comme metadata authorization (ou sous le nom propre de la clé) sur l’appel — un placement en requête ne circule jamais sur un appel gRPC. Une ligne de metadata explicite du même nom prend le pas.',
  'workbench.editors.grpc.auth.ownUnsupported': '{type} ne peut pas s’appliquer à un appel gRPC.',
  ...
  'workbench.editors.grpc.timeline.scriptFailed': '{hook} a échoué — {error}',
  'workbench.editors.grpc.response.tab.scripts': 'Scripts',
  'workbench.editors.grpc.scripts.empty': 'Aucun script n’a été exécuté dans cet appel.',
  'workbench.editors.grpc.scripts.console': 'Console',
  'workbench.editors.grpc.scripts.tests': 'Tests',
  'workbench.editors.grpc.scripts.consoleEmpty': 'Rien n’a été journalisé.',
  'workbench.editors.grpc.scripts.testsEmpty': 'Aucune assertion enregistrée.',
  'workbench.editors.grpc.scripts.attempt': 'tentative {attempt}',
  'workbench.editors.grpc.scripts.atMessage': 'message {index}',
  'workbench.editors.grpc.scripts.tag': 'Scripts · {count}',
  'workbench.editors.grpc.scripts.tagTitle': 'Scripts de l’appel',
  'workbench.editors.grpc.scripts.tagSummary': 'Les hooks exécutés dans cet appel, avec les niveaux qui ont contribué.',
  'workbench.editors.grpc.scripts.tagSummaryFailed': 'Un hook a échoué — sa dernière erreur figure sous lui.',
  'workbench.editors.grpc.scripts.runs': '{count} exécutions',
  'workbench.editors.grpc.scripts.runsOne': '1 exécution',
