...
export const workbenchChrome = {
  ...
  'workbench.tabbar.createRule': 'Créer une règle',
  ...
  'workbench.shell.commandPalette.cmd.openTrustedRoots': 'Ouvrir les certificats de confiance',
  ...
  'workbench.shell.topbar.layout.bottomLayout': 'Disposition du panneau inférieur',
  ...
  'workbench.shell.topbar.layout.splitColumns': 'Côte à côte',
  'workbench.shell.topbar.layout.splitRows': 'Empilés',
  ...
  'workbench.shell.empty.createRequestDesc': 'HTTP, gRPC, WebSocket et plus',
  ...
  'workbench.shell.tabLabel.newMqttRequest': 'Nouvelle requête MQTT',
  'workbench.shell.tabLabel.newGraphqlRequest': 'Nouvelle requête GraphQL',
  ...
  //    rows, drag previews) ───────────────────────────────────────────
  'workbench.toolWindows.serverAdmin': 'Admin du serveur',
  'workbench.toolWindows.httpRules': 'Intercepteur navigateur',
  ...
  'workbench.toolWindows.info.serverAdmin.summary':
    'Administrer ce serveur : les utilisateurs et leurs accès, les appareils appairés, les liaisons de ' +
    "dépôts et le journal d'audit. Chaque ligne ouvre son propre onglet.",
  'workbench.toolWindows.info.serverAdmin.domainsHeading': "Domaines d'administration",
  ...
  'workbench.commitTool.oneDirectory': '1 répertoire',
  'workbench.commitTool.directoriesCount': '{count} répertoires',
  'workbench.commitTool.dirsAndFiles': '{dirs} et {files}',
  ...
  'workbench.commitTool.rollback': 'Annuler les modifications…',
  'workbench.commitTool.shelve': 'Mettre de côté silencieusement',
  'workbench.commitTool.show': 'Afficher',
  'workbench.commitTool.ignoredFiles': 'Fichiers ignorés',
  'workbench.commitTool.selectOpened': 'Sélectionner le fichier ouvert dans la vue des modifications',
  'workbench.commitTool.amend': 'Amender',
  'workbench.commitTool.historyTooltip': 'Historique des messages de commit',
  'workbench.commitTool.historyEmpty': 'Aucun message committé pour l’instant',
  'workbench.commitTool.messagePlaceholder': 'Message de commit',
  'workbench.commitTool.commit': 'Commit',
  'workbench.commitTool.commitAndPush': 'Commit et pousser…',
  'workbench.commitTool.optionsTooltip': 'Afficher les options de commit',
  'workbench.commitTool.options.gitSection': 'Git',
  'workbench.commitTool.options.signOff': 'Commit avec sign-off',
  'workbench.commitTool.options.runGitHooks': 'Exécuter les hooks Git',
  'workbench.commitTool.counter.modified': '{count} modifié(s)',
  'workbench.commitTool.counter.added': '{count} ajouté(s)',
  'workbench.commitTool.counter.deleted': '{count} supprimé(s)',
  'workbench.commitTool.counter.unversioned': '{count} non versionné(s)',
  'workbench.commitTool.nothingToCommit': 'Aucune modification dans les fichiers sélectionnés',
  'workbench.commitTool.committed': 'Commit {sha} créé',
  'workbench.commitTool.menu.commitFile': 'Commit du fichier…',
  'workbench.commitTool.menu.moveToChangelist': 'Déplacer vers une autre liste de modifications…',
  'workbench.commitTool.menu.showDiff': 'Afficher les différences',
  'workbench.commitTool.menu.showDiffNewTab': 'Afficher les différences dans un nouvel onglet',
  'workbench.commitTool.menu.jumpToSource': 'Aller à la source',
  'workbench.commitTool.menu.delete': 'Supprimer…',
  'workbench.commitTool.menu.addToVcs': 'Ajouter au VCS',
  'workbench.commitTool.menu.addToGitignore': 'Ajouter à .gitignore',
  'workbench.commitTool.menu.excludeFile': '.git/info/exclude',
  'workbench.commitTool.menu.newChangelist': 'Nouvelle liste de modifications…',
  'workbench.commitTool.menu.editChangelist': 'Modifier la liste de modifications…',
  'workbench.commitTool.menu.createPatch': 'Créer un patch à partir des modifications locales…',
  'workbench.commitTool.menu.copyPatch': 'Copier comme patch dans le presse-papiers',
  'workbench.commitTool.menu.shelveChanges': 'Mettre de côté les modifications…',
  'workbench.commitTool.menu.localHistory': 'Historique local',
  'workbench.commitTool.menu.localHistoryShow': "Afficher l'historique…",
  'workbench.commitTool.menu.showProjectHistory': "Afficher l'historique du projet…",
  'workbench.commitTool.menu.recentChanges': 'Modifications récentes',
  'workbench.commitTool.menu.putLabel': 'Ajouter un libellé…',
  'workbench.commitTool.menu.git': 'Git',
  'workbench.commitTool.menu.add': 'Ajouter',
  'workbench.commitTool.menu.compareRevision': 'Comparer avec la révision…',
  'workbench.commitTool.menu.compareBranch': 'Comparer avec une branche ou un tag…',
  'workbench.commitTool.menu.showHistory': "Afficher l'historique",
  'workbench.commitTool.menu.showCurrentRevision': 'Afficher la révision actuelle',
  'workbench.commitTool.menu.push': 'Pousser…',
  'workbench.commitTool.menu.pull': 'Pull…',
  'workbench.commitTool.menu.fetch': 'Récupérer',
  'workbench.commitTool.menu.merge': 'Fusionner…',
  'workbench.commitTool.menu.rebase': 'Rebaser…',
  'workbench.commitTool.menu.branches': 'Branches…',
  'workbench.commitTool.menu.newBranch': 'Nouvelle branche…',
  'workbench.commitTool.menu.newTag': 'Nouveau tag…',
  'workbench.commitTool.menu.resetHead': 'Réinitialiser HEAD…',
  'workbench.commitTool.menu.stash': 'Remiser les modifications…',
  'workbench.commitTool.menu.unstash': 'Restaurer les modifications remisées…',
  'workbench.commitTool.menu.github': 'GitHub',
  'workbench.commitTool.menu.manageRemotes': 'Gérer les dépôts distants…',
  'workbench.commitTool.menu.clone': 'Cloner…',
  'workbench.commitTool.menu.comparePickerTitle': 'Comparer avec une branche ou un tag',
  'workbench.commitTool.menu.comparePickerSearch': 'Rechercher branches et tags',
  'workbench.commitTool.menu.comparePickerEmpty': 'Aucune référence correspondante',
  ...
  'workbench.commitTool.menu.stopIgnoring': 'Ne plus ignorer',
  ...
  'workbench.commitTool.errors.notARepo': 'Cet espace de travail n’a pas de dépôt Git',
  'workbench.commitTool.errors.gitUnavailable': 'Git n’est pas disponible sur cette machine',
  'workbench.commitTool.errors.emptyMessage': 'Saisissez un message de commit',
  'workbench.commitTool.errors.noPaths': 'Sélectionnez au moins un fichier à committer',
  'workbench.commitTool.errors.amendUnborn': 'Il n’y a pas encore de commit à amender',
  'workbench.commitTool.errors.amendMerge': 'Les commits de fusion ne peuvent pas être amendés',
  'workbench.commitTool.errors.amendPushed':
    'HEAD est déjà poussé vers son upstream — amender réécrirait un historique publié',
  'workbench.commitTool.errors.stageFailed': 'Impossible d’indexer les fichiers sélectionnés',
  'workbench.commitTool.errors.commitFailed': 'Échec du commit',
  'workbench.commitTool.errors.pushFailed': 'Échec du push',
