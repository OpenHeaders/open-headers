...
export const sharedWorkspace = {
  ...
  'shared.org.hint.desktop': 'Cet ordinateur',
  'shared.org.hint.serverLocal': 'Serveur local',
  'shared.org.hint.serverRemote': 'Serveur distant',

  // ── Org places — what a joined Org's group header reads as ─────────
  'shared.org.place.desktopApp': 'Cet ordinateur · application de bureau',
  'shared.org.place.desktopAppNamed': '{name} · application de bureau',
  'shared.org.place.server': '{name} · serveur',
  ...
  'shared.org.sync.orphaned': 'connexion supprimée — copies locales',

  // ── Org states beside a place (the switcher headers name the place) ─
  'shared.org.state.off': 'désactivé, pas de synchronisation',
  'shared.org.state.repair': 'réassociation nécessaire',
  'shared.org.state.disconnected': 'déconnecté',
  ...
  'shared.org.scope.local.serverLan': 'Partagé sur ce serveur. Synchronisé via le réseau local (LAN).',
  'shared.org.scope.local.serverWan': 'Partagé sur ce serveur. Synchronisé via internet (WAN).',
  'shared.org.scope.local.serverLoopback': 'Réside sur ce serveur — seule cette machine peut se connecter.',
  ...
  'shared.org.scope.personal.serverWan': 'Synchronisé avec votre serveur via internet (WAN).',
  'shared.org.scope.personal.serverLan': 'Synchronisé avec votre serveur via le réseau local (LAN).',
  ...
  'shared.workspaceDropdown.noAccessRow': 'Aucun espace de travail — accès non accordé',
  'shared.workspaceDropdown.openPlace': 'Ouvrir {place}',
