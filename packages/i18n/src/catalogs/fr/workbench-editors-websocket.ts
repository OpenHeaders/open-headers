...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.session.knobAuth': 'l’en-tête d’identifiants de la poignée de main',
  ...
  'workbench.editors.websocket.timeline.scriptFailed': '{hook} a échoué — {error}',
  'workbench.editors.websocket.timeline.scriptDropped': '{hook} a abandonné le message — {level}',
  'workbench.editors.websocket.timeline.scriptAttempt': 'tentative {attempt}',
  'workbench.editors.websocket.session.view.timeline': 'Chronologie',
  'workbench.editors.websocket.session.view.scripts': 'Scripts',
  'workbench.editors.websocket.session.scripts.empty': 'Aucun script n’a été exécuté dans cette session.',
  'workbench.editors.websocket.session.scripts.console': 'Console',
  'workbench.editors.websocket.session.scripts.tests': 'Tests',
  'workbench.editors.websocket.session.scripts.consoleEmpty': 'Rien n’a été journalisé.',
  'workbench.editors.websocket.session.scripts.testsEmpty': 'Aucune assertion enregistrée.',
  'workbench.editors.websocket.session.scripts.attempt': 'tentative {attempt}',
  'workbench.editors.websocket.session.scripts.atMessage': 'message {index}',
  'workbench.editors.websocket.session.scripts.tag': 'Scripts · {count}',
  'workbench.editors.websocket.session.scripts.tagTitle': 'Scripts de session',
  'workbench.editors.websocket.session.scripts.tagSummary':
    'Les hooks exécutés dans cette session, avec les niveaux qui ont contribué.',
  'workbench.editors.websocket.session.scripts.tagSummaryFailed':
    'Un hook a échoué — sa dernière erreur figure dessous.',
  'workbench.editors.websocket.session.scripts.runs': '{count} exécutions',
  'workbench.editors.websocket.session.scripts.runsOne': '1 exécution',
  'workbench.editors.websocket.session.scripts.failed': '{count} en échec',
  'workbench.editors.websocket.session.scripts.dropped': '{count} abandonnés',
  'workbench.editors.websocket.session.scripts.marksCapped':
    'Le détail par événement s’est arrêté après {count} exécutions ; les hooks continuent de s’exécuter et les compteurs complets arrivent à la fin de la session.',
