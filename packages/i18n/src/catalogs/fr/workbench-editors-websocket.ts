...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.timeline.showHexdump': 'Afficher le hexdump',
  'workbench.editors.websocket.timeline.showMessage': 'Afficher le message',
  'workbench.editors.websocket.timeline.viewerFormat': 'Format du message',
