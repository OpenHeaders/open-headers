...
export const workbenchServerAdmin = {
  ...
  'workbench.serverAdmin.build.sectionHint': 'Le build du serveur que cette console administre.',
  'workbench.serverAdmin.build.versionLabel': 'Version',
  'workbench.serverAdmin.build.versionUnknown': 'Inconnue',
  ...
  'workbench.serverAdmin.audit.capSsoAdmin': 'Admin SSO (déclaré)',
  'workbench.serverAdmin.audit.capDeviceLogin': "Connexion d'un appareil (approuvée)",
  ...
  'workbench.serverAdmin.audit.eventDeviceLogin': "Connexion d'un appareil",
