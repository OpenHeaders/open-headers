...
export const workbenchSettings = {
  ...
  'workbench.settings.category.mcp.description':
    ...
    'défaut.',
  'workbench.settings.category.mcpAccess.label': 'Accès',
  ...
  'workbench.settings.category.devpanelLayout.label': 'Disposition',
  ...
  'workbench.settings.category.codeEditor.label': 'Éditeur de code',
  ...
  'workbench.settings.category.diffViewer.label': 'Visionneuse de diff',
  ...
  'workbench.settings.category.gitFolder.label': 'Dossier',
  ...
  'workbench.settings.category.gitAutomation.label': 'Automatisation',
  ...
  'workbench.settings.category.proxyOutbound.label': 'Requêtes sortantes',
  ...
  'workbench.settings.category.proxyTrust.label': 'Confiance HTTPS',
