...
export const web = {
  ...
  'web.consent.wouldSignIn': '{who} souhaite se connecter à ce serveur',
  'web.consent.grantBody':
    "Une fois autorisé, l'appareil agit en votre nom sur ce serveur et peut faire tout ce que votre compte peut faire.",
  ...
  'web.consent.fromDevice': 'Depuis {device}.',
  ...
  'web.consent.switchAccount': 'Changer de compte',
