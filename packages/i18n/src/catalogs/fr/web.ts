...
export const web = {
  'web.gate.titleSignIn': 'Se connecter à ce Team Server',
  'web.gate.titlePair': "S'associer à ce Team Server",
  'web.gate.introSso': "Connectez-vous avec {provider}, ou collez un jeton d'association ci-dessous.",
  'web.gate.introPassword':
    "Connectez-vous avec l'email et le mot de passe définis pour vous par l'admin du Team Server, ou collez un jeton " +
    "d'association ci-dessous.",
  'web.gate.introTokenPrefix':
    "Ce Team Server OpenHeaders exige un jeton d'association. Générez-en un sur la machine qui l'exécute avec",
  ...
  'web.gate.errorTokenRejected': 'Le Team Server a rejeté ce jeton. Vérifiez-le et réessayez.',
  'web.gate.errorTokenOffline': "Le Team Server n'a pas répondu. Vérifiez qu'il est lancé et réessayez.",
  'web.gate.errorPasswordRefused': "Échec de la connexion. Vérifiez l'email et le mot de passe et réessayez.",
  'web.gate.errorSessionRefused': "Le Team Server n'a pas accepté la session. Réessayez.",
  ...
  'web.oidcError.unknownUser':
    "Connecté, mais ce Team Server n'a aucun utilisateur pour votre email. Demandez à l'admin du Team Server de vous " +
    'ajouter.',
  'web.oidcError.userDeactivated':
    "Connecté, mais votre utilisateur sur ce Team Server est désactivé. Voyez avec l'admin du Team Server.",
  ...
  'web.oidcError.seatLimitReached':
    "Connecté, mais ce Team Server n'a aucun siège libre pour un nouvel utilisateur. Demandez à l'admin du Team Server — " +
    'ou entrez dès maintenant avec votre propre siège individuel.',
  'web.oidcError.personalSeatsDisabled':
    "Les sièges individuels sont désactivés sur ce Team Server. Demandez un siège à l'admin du Team Server.",
  ...
  'web.oidcError.personalLicenseNoIdentity':
    "Votre connexion ne portait aucun email à confronter au siège individuel. Voyez avec l'admin du Team Server.",
  ...
  'web.insecure.httpsPrefix':
    'Via HTTPS — placez le Team Server derrière un reverse proxy TLS (voir « Behind a reverse proxy » dans le README ' +
    'du Team Server) et ouvrez',
  'web.insecure.httpsSuffix': '.',
  'web.insecure.loopbackPrefix': 'Sur la machine du Team Server elle-même à',
