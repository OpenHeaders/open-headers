...
export const workbenchSettingsPanes = {
  ...
  'workbench.settings.backendPane.detail.aria.local-self-hosted': 'Back-end de serveur sur le LAN local',
  ...
  'workbench.settings.systemProxy.manual.urlPlaceholder': 'proxy.example:8080 ou http://proxy.example:8080',
