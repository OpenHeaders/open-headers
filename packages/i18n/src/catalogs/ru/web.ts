...
export const web = {
  ...
  'web.consent.title': 'Подтвердить это устройство?',
  ...
  'web.consent.asksAs': '{who} запрашивает вход на этот сервер от имени пользователя {name}.',
  'web.consent.asksAsYou': '{who} запрашивает вход на этот сервер от вашего имени.',
