...
export const web = {
  ...
  'web.overlay.takingYouBack': '{client} 화면으로 돌아가는 중…',
  ...
  'web.consent.title': '이 기기를 승인하시겠습니까?',
  ...
  'web.consent.asksAs': '{who}에서 {name} 계정으로 이 서버에 로그인을 요청했습니다.',
  'web.consent.asksAsYou': '{who}에서 본인 계정으로 이 서버에 로그인을 요청했습니다.',
  'web.consent.code': '코드 {code}: 기기에 표시된 코드와 일치하는지 확인하세요.',
  'web.consent.expires': '약 {minutes}분 후 만료',
  'web.consent.allow': '허용',
  'web.consent.notMe': '본인 아님',
  'web.consent.approvedTitle': '기기 승인됨',
  'web.consent.approvedBody': '기기가 본인 계정으로 로그인되었습니다. 이 탭을 닫아도 됩니다.',
  'web.consent.deniedTitle': '로그인 거부됨',
  'web.consent.deniedBody': '해당 기기는 로그인되지 않습니다. 이 탭을 닫아도 됩니다.',
  'web.consent.expiredTitle': '로그인 요청 만료됨',
  'web.consent.expiredBody': '유효 시간이 지났습니다. 기기에서 로그인을 다시 시작하세요.',
  'web.consent.notFoundTitle': '로그인 요청을 찾을 수 없음',
  'web.consent.notFoundBody': '이 요청은 만료되었거나 발급된 적이 없습니다. 기기에서 로그인을 다시 시작하세요.',
  'web.consent.offlineTitle': '로그인을 사용할 수 없음',
  'web.consent.continue': 'Workbench 화면으로 계속',
