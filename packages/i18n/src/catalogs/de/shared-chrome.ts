...
export const sharedChrome = {
  ...
  // ── System Status pill ─────────────────────────────────────────────
  'shared.chrome.status.title': 'Systemstatus',
  ...
  'shared.chrome.updates.restartToInstall': 'Zum Installieren neu starten',
  'shared.chrome.updates.download': 'Herunterladen',
