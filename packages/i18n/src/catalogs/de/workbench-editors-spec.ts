...
export const workbenchEditorsSpec = {
  ...
  'workbench.editors.spec.outline.groups.types': 'Typen',
  'workbench.editors.spec.outline.groups.interfaces': 'Interfaces',
  'workbench.editors.spec.outline.groups.unions': 'Unions',
  'workbench.editors.spec.outline.groups.inputs': 'Eingaben',
  'workbench.editors.spec.outline.groups.scalars': 'Skalare',
  'workbench.editors.spec.outline.groups.directives': 'Direktiven',
