...
export const web = {
  ...
  'web.consent.wouldSignIn': '{who} möchte sich auf diesem Server anmelden',
  'web.consent.grantBody':
    'Nach der Freigabe handelt das Gerät auf diesem Server in deinem Namen und kann alles tun, was dein Konto kann.',
  ...
  'web.consent.switchAccount': 'Konto wechseln',
