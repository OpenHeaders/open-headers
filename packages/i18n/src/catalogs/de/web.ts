...
export const web = {
  'web.gate.titleSignIn': 'Bei diesem Team Server anmelden',
  'web.gate.titlePair': 'Mit diesem Team Server koppeln',
  'web.gate.introSso': 'Melde dich mit {provider} an oder füge unten einen Kopplungstoken ein.',
  'web.gate.introPassword':
    'Melde dich mit der E-Mail-Adresse und dem Passwort an, die der Team-Server-Admin für dich festgelegt hat, oder ' +
    'füge unten einen Kopplungstoken ein.',
  'web.gate.introTokenPrefix':
    'Dieser Team Server von OpenHeaders verlangt einen Kopplungstoken. Erzeuge einen auf der Maschine, auf der er läuft, mit',
  ...
  'web.gate.errorTokenRejected': 'Der Team Server hat diesen Token abgelehnt. Prüfe ihn und versuche es erneut.',
  'web.gate.errorTokenOffline': 'Der Team Server hat nicht geantwortet. Prüfe, ob er läuft, und versuche es erneut.',
  'web.gate.errorPasswordRefused':
    'Anmeldung fehlgeschlagen. Prüfe E-Mail-Adresse und Passwort und versuche es erneut.',
  'web.gate.errorSessionRefused': 'Der Team Server hat die Sitzung nicht akzeptiert. Versuche es erneut.',
  ...
  'web.oidcError.unknownUser':
    'Angemeldet, aber dieser Team Server hat keinen Benutzer für deine E-Mail-Adresse. Bitte den Team-Server-Admin, dich ' +
    'hinzuzufügen.',
  'web.oidcError.userDeactivated':
    'Angemeldet, aber dein Benutzer auf diesem Team Server ist deaktiviert. Wende dich an den Team-Server-Admin.',
  ...
  'web.oidcError.seatLimitReached':
    'Angemeldet, aber dieser Team Server hat keine freien Plätze für einen neuen Benutzer. Wende dich an den ' +
    'Team-Server-Admin — oder komm jetzt mit deinem eigenen Einzelplatz hinein.',
  'web.oidcError.personalSeatsDisabled':
    'Einzelplätze sind auf diesem Team Server deaktiviert. Frag den Team-Server-Admin nach einem Platz.',
  ...
  'web.insecure.httpsPrefix':
    'Über HTTPS — stelle den Team Server hinter einen TLS-Reverse-Proxy (siehe „Behind a reverse proxy“ im README ' +
    'des Team Servers) und öffne',
  'web.insecure.httpsSuffix': '.',
  'web.insecure.loopbackPrefix': 'Auf der Maschine des Team Servers selbst unter',
