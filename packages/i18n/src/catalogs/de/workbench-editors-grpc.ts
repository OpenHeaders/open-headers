...
export const workbenchEditorsGrpc = {
  ...
  'workbench.editors.grpc.tab.scripts': 'Skripte',
  ...
  'workbench.editors.grpc.timeline.scriptFailed': '{hook} fehlgeschlagen — {error}',
  'workbench.editors.grpc.response.tab.scripts': 'Skripte',
  'workbench.editors.grpc.scripts.empty': 'In diesem Aufruf wurde kein Skript ausgeführt.',
  'workbench.editors.grpc.scripts.console': 'Konsole',
  'workbench.editors.grpc.scripts.tests': 'Tests',
  'workbench.editors.grpc.scripts.consoleEmpty': 'Nichts protokolliert.',
  'workbench.editors.grpc.scripts.testsEmpty': 'Keine Assertions registriert.',
  'workbench.editors.grpc.scripts.attempt': 'Versuch {attempt}',
  'workbench.editors.grpc.scripts.atMessage': 'Nachricht {index}',
  'workbench.editors.grpc.scripts.tag': 'Skripte · {count}',
  'workbench.editors.grpc.scripts.tagTitle': 'Aufruf-Skripte',
  'workbench.editors.grpc.scripts.tagSummary':
    'Die in diesem Aufruf ausgeführten Hooks mit den Ebenen, die beigetragen haben.',
  'workbench.editors.grpc.scripts.tagSummaryFailed':
    'Ein Hook ist fehlgeschlagen — sein letzter Fehler steht darunter.',
  'workbench.editors.grpc.scripts.runs': '{count} Läufe',
  'workbench.editors.grpc.scripts.runsOne': '1 Lauf',
  'workbench.editors.grpc.scripts.failed': '{count} fehlgeschlagen',
  'workbench.editors.grpc.scripts.dropped': '{count} verworfen',
  'workbench.editors.grpc.scripts.marksCapped':
    'Die Details pro Nachricht endeten nach {count} Läufen; die Hooks laufen weiter, die vollständigen Zähler kommen mit dem Ende des Aufrufs.',
