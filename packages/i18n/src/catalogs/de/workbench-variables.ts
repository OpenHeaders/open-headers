...
export const workbenchVariables = {
  ...
  'workbench.variables.table.smProvider.oskeychain': 'Anmeldedatenspeicher des Systems',
  ...
  'workbench.variables.table.smField.provider': 'Anbieter',
  'workbench.variables.table.smField.vault': 'Vault',
  'workbench.variables.table.smField.item': 'Element',
  'workbench.variables.table.smField.field': 'Feld',
  'workbench.variables.table.smField.account': 'Konto',
  'workbench.variables.table.smField.secretId': 'Secret-ID',
  'workbench.variables.table.smField.service': 'Dienst',
  ...
  'workbench.variables.table.smField.path': 'Pfad',
  ...
  'workbench.variables.vault.secretsCount':
    'SECRETS ({strings} String · {totps} TOTP · {certs} Zertifikat · {refs} Secret-Manager)',
