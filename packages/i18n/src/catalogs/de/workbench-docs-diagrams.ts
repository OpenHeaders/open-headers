...
export const workbenchDocsDiagrams = {
  ...
  'workbench.docs.diagrams.openHeaders.roadmapDesktop.featHttpRules': 'Browser Interceptor',
  ...
  'workbench.docs.diagrams.openHeaders.roadmapImporters.targetRules': 'Browser Interceptor',
