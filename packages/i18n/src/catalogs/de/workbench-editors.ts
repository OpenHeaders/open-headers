...
export const workbenchEditors = {
  ...
  'workbench.editors.scriptEditor.group.requests': 'Anfragen',
  'workbench.editors.scriptEditor.group.response': 'Antwort',
  'workbench.editors.scriptEditor.group.close': 'Schließen',
  ...
  'workbench.editors.scriptEditor.snippet.jsonValueCheck': 'Der JSON-Wert im Antwort-Body ist korrekt',
  'workbench.editors.scriptEditor.snippet.headerCheck': 'Der Content-Type-Header ist vorhanden',
  ...
  'workbench.editors.scriptEditor.group.invoke': 'Aufruf',
  'workbench.editors.scriptEditor.snippet.grpcSetMetadata': 'Ein Metadaten-Paar setzen',
  'workbench.editors.scriptEditor.snippet.grpcRemoveMetadata': 'Ein Metadaten-Paar entfernen',
  'workbench.editors.scriptEditor.snippet.grpcSetMessage': 'Die Anfragenachricht umschreiben',
  'workbench.editors.scriptEditor.snippet.grpcLogCall': 'Den Aufruf protokollieren',
  'workbench.editors.scriptEditor.snippet.grpcLogMessage': 'Die dekodierte Nachricht protokollieren',
  'workbench.editors.scriptEditor.snippet.grpcCountMessages': 'Nachrichten über den Aufruf zählen',
  'workbench.editors.scriptEditor.snippet.grpcAssertDecoded': 'Nachricht dekodiert',
  'workbench.editors.scriptEditor.snippet.grpcAssertField': 'Nachrichtenfeld ist gesetzt',
  'workbench.editors.scriptEditor.snippet.grpcSaveMessageValue': 'Einen Nachrichtenwert in einer Variablen speichern',
  'workbench.editors.scriptEditor.snippet.grpcStatusOk': 'Status ist OK',
  'workbench.editors.scriptEditor.snippet.grpcMessageCount': 'Nachrichten sind eingetroffen',
  'workbench.editors.scriptEditor.snippet.grpcTrailerCheck': 'Der Trailer ist vorhanden',
  'workbench.editors.scriptEditor.snippet.logRequest': 'Die Anfrage protokollieren',
  'workbench.editors.scriptEditor.snippet.parseJsonBody': 'Den JSON-Body parsen',
  'workbench.editors.scriptEditor.snippet.findResponseHeader': 'Einen Antwort-Header finden',
  'workbench.editors.scriptEditor.snippet.logResponse': 'Die Antwort protokollieren',
  'workbench.editors.scriptEditor.snippet.logDial': 'Den Verbindungsaufbau protokollieren',
  'workbench.editors.scriptEditor.snippet.logOutgoingMessage': 'Die ausgehende Nachricht protokollieren',
  'workbench.editors.scriptEditor.snippet.logMessage': 'Die Nachricht protokollieren',
  'workbench.editors.scriptEditor.snippet.logClose': 'Das Schließen protokollieren',
  'workbench.editors.scriptEditor.snippet.wsReplyBinary': 'Mit einem binären Frame antworten',
  'workbench.editors.scriptEditor.snippet.wsNothingDropped': 'Nichts wurde verworfen',
  'workbench.editors.scriptEditor.snippet.mqttSetResponseTopic': 'Ein Antwort-Topic setzen',
  'workbench.editors.scriptEditor.snippet.mqttSetPublishUserProperty': 'Eine PUBLISH-User-Property setzen',
  'workbench.editors.scriptEditor.snippet.mqttConnackAccepted': 'Der Broker hat die Sitzung angenommen',
  'workbench.editors.scriptEditor.snippet.grpcLogStatus': 'Den Status protokollieren',
