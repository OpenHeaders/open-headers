...
export const workbenchSettingsPanes = {
  ...
  'workbench.settings.backendPane.wizard.signIn.cancelSignIn': 'Anmeldung abbrechen',
  ...
  'workbench.settings.backendPane.connections.connectDesktop': 'Desktop-App verbinden',
  'workbench.settings.backendPane.connections.signInServer': 'Bei einem Server anmelden…',
  'workbench.settings.backendPane.connections.emptyDesktopLine':
    'Über die Browser dieses Computers hinweg synchronisieren: die Desktop-App verbinden.',
  'workbench.settings.backendPane.connections.emptyServerLine':
    'Über deine Geräte hinweg oder mit einem Team synchronisieren: bei einem OpenHeaders Server anmelden.',
  'workbench.settings.backendPane.connections.menu.connect': 'Verbinden',
  'workbench.settings.backendPane.connections.menu.disconnect': 'Trennen',
  'workbench.settings.backendPane.connections.menu.edit': 'Bearbeiten…',
  'workbench.settings.backendPane.connections.menu.remove': 'Entfernen…',
  'workbench.settings.backendPane.connections.place.desktopApp': 'Desktop-App auf diesem Computer',
  'workbench.settings.backendPane.placement.section': 'Neue Arbeitsbereiche',
  'workbench.settings.backendPane.placement.label': 'Wohin sie gehen',
  'workbench.settings.backendPane.placement.description':
    'Jederzeit änderbar. Bestehende Arbeitsbereiche bleiben, wo sie sind.',
  ...
  'workbench.settings.backendTokens.explainer.pairText':
    'zeigt einen kurzen Code, den das Gerät unter Sicherung und Synchronisierung › Synchronisierung › Mit einem Code ' +
  ...
  'workbench.settings.backendTokens.empty':
    'Noch keine Geräte. Erzeuge einen Token und füge ihn auf dem Gerät unter Sicherung und Synchronisierung › ' +
    'Synchronisierung ein, oder kopple ein Gerät und lass es dort den Code eingeben.',
  ...
  'workbench.settings.backendTokens.pairModal.intro.settingsPath': 'Sicherung und Synchronisierung › Synchronisierung',
  ...
  'workbench.settings.systemProxy.previewSection': 'Routenvorschau',
  ...
  'workbench.settings.systemProxy.mode.systemDesc':
    ...
    'Erkennung — genau wie der Browser. Der Standard; eine unverwaltete Maschine verbindet sich einfach ' +
    'direkt.',
  'workbench.settings.systemProxy.system.valuesLabel': 'Systemwerte',
  'workbench.settings.systemProxy.system.sourcedNote':
    'Von dieser Maschine gelesen ({source}) — die Auflösung antwortet weiterhin pro URL.',
  ...
  'workbench.settings.systemProxy.mode.pacDesc':
    ...
    'isolierten Browser-Netzwerkstapels, nie in der App.',
  ...
  'workbench.settings.proxyTrustPane.helper.state.notFound':
    'Nicht gefunden — macOS hat keinen Eintrag dazu; registriere ihn erneut',
  ...
  'workbench.settings.gitPane.section.workingTree': 'Arbeitsbaum',
  'workbench.settings.gitPane.section.branches': 'Branches',
  'workbench.settings.gitPane.section.commit': 'Commit',
  'workbench.settings.gitPane.section.history': 'Verlauf',
