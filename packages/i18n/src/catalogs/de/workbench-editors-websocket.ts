...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.tab.scripts': 'Skripte',
  'workbench.editors.websocket.timeline.script': '{hook} — {levels}',
  'workbench.editors.websocket.timeline.scriptFailed': '{hook} fehlgeschlagen — {error}',
  'workbench.editors.websocket.timeline.scriptDropped': '{hook} hat die Nachricht verworfen — {level}',
  'workbench.editors.websocket.timeline.scriptAttempt': 'Versuch {attempt}',
  'workbench.editors.websocket.session.view.timeline': 'Zeitleiste',
  'workbench.editors.websocket.session.view.scripts': 'Skripte',
  'workbench.editors.websocket.session.scripts.empty': 'In dieser Sitzung wurde kein Skript ausgeführt.',
  'workbench.editors.websocket.session.scripts.console': 'Konsole',
  'workbench.editors.websocket.session.scripts.tests': 'Tests',
  'workbench.editors.websocket.session.scripts.consoleEmpty': 'Nichts protokolliert.',
  'workbench.editors.websocket.session.scripts.testsEmpty': 'Keine Assertions registriert.',
  'workbench.editors.websocket.session.scripts.attempt': 'Versuch {attempt}',
  'workbench.editors.websocket.session.scripts.atMessage': 'Nachricht {index}',
  'workbench.editors.websocket.session.scripts.tag': 'Skripte · {count}',
  'workbench.editors.websocket.session.scripts.tagTitle': 'Sitzungsskripte',
  'workbench.editors.websocket.session.scripts.tagSummary':
    'Die in dieser Sitzung ausgeführten Hooks mit den beteiligten Ebenen.',
  'workbench.editors.websocket.session.scripts.tagSummaryFailed':
    'Ein Hook ist fehlgeschlagen — sein letzter Fehler steht darunter.',
  'workbench.editors.websocket.session.scripts.runs': '{count} Läufe',
  'workbench.editors.websocket.session.scripts.runsOne': '1 Lauf',
  'workbench.editors.websocket.session.scripts.failed': '{count} fehlgeschlagen',
  'workbench.editors.websocket.session.scripts.dropped': '{count} verworfen',
  'workbench.editors.websocket.session.scripts.marksCapped':
    'Die Details pro Ereignis endeten nach {count} Läufen; die Hooks laufen weiter, die vollständigen Zähler kommen mit dem Sitzungsende.',
