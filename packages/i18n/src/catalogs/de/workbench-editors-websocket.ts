...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.timeline.showHexdump': 'Hexdump anzeigen',
  'workbench.editors.websocket.timeline.showMessage': 'Nachricht anzeigen',
  'workbench.editors.websocket.timeline.viewerFormat': 'Nachrichtenformat',
