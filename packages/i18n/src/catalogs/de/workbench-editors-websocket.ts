...
export const workbenchEditorsWebsocket = {
  ...
  'workbench.editors.websocket.connect.browserHost': 'WebSocket-Sitzungen laufen in der Desktop-App oder im Daemon.',
  ...
  'workbench.editors.websocket.auth.helpRaw':
    'Wird beim Handshake als Header Authorization: Bearer gesendet — gilt in der Desktop-App oder im Daemon; ' +
  ...
  'workbench.editors.websocket.auth.helpSocketio':
    ...
    'oder im Daemon als Handshake-Header Authorization: Bearer. Eine explizite Authorization-Header-Zeile hat ' +
  ...
  'workbench.editors.websocket.headers.nodeOnly':
    'Benutzerdefinierte Handshake-Header gelten, wenn die Sitzung in der Desktop-App oder im Daemon läuft — ' +
  ...
  'workbench.editors.websocket.settings.sslVerifyHelp':
    ...
    'Entwicklungsserver aus. Gilt in der Desktop-App oder im Daemon.',
