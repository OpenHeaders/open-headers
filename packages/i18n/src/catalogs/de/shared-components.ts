...
export const sharedComponents = {
  ...
  'shared.dock.slot.bottomTop': 'Unten oberer Bereich',
  'shared.dock.slot.bottomBottom': 'Unten unterer Bereich',
  ...
  'shared.codeEditor.find': 'Suchen',
  'shared.codeEditor.replace': 'Ersetzen',
  'shared.codeEditor.format': 'Formatieren',
  'shared.codeEditor.formatError': 'Formatieren nicht möglich — Parsefehler',
  ...
  'shared.peerExecute.localDisabled':
    ...
    'dieses Geräts das Senden von Anfragen erlauben“ unter Sicherung und Synchronisierung › Deine Geräte.',
  ...
  'shared.desktopTeaser.commit.body':
    'Prüfe und committe die Änderungen deines Arbeitsbereichs — ein abhakbarer Dateibaum mit Datei-Diffs und einem Feld für die Commit-Nachricht.',
