...
export const workbenchDaemonAdmin = {
  // ── Console shell ──────────────────────────────────────────────────
  'workbench.daemonAdmin.title': 'Server-Verwaltung',
  ...
  'workbench.daemonAdmin.deniedDescription': 'Die Verwaltung dieses Servers erfordert die Capability daemon.admin.',
