...
export const workbenchEditorsMqtt = {
  ...
  'workbench.editors.mqtt.session.tab.scripts': 'Skripte',
  'workbench.editors.mqtt.tab.scripts': 'Skripte',
  'workbench.editors.mqtt.timeline.script': '{hook} — {levels}',
  'workbench.editors.mqtt.timeline.scriptFailed': '{hook} fehlgeschlagen — {error}',
  'workbench.editors.mqtt.timeline.scriptDropped': '{hook} hat die Nachricht verworfen — {level}',
  'workbench.editors.mqtt.timeline.scriptAttempt': 'Versuch {attempt}',
  'workbench.editors.mqtt.session.scripts.empty': 'In dieser Sitzung wurde kein Skript ausgeführt.',
  'workbench.editors.mqtt.session.scripts.console': 'Konsole',
  'workbench.editors.mqtt.session.scripts.tests': 'Tests',
  'workbench.editors.mqtt.session.scripts.consoleEmpty': 'Nichts protokolliert.',
  'workbench.editors.mqtt.session.scripts.testsEmpty': 'Keine Assertions registriert.',
  'workbench.editors.mqtt.session.scripts.attempt': 'Versuch {attempt}',
  'workbench.editors.mqtt.session.scripts.atMessage': 'Ereignis {index}',
  'workbench.editors.mqtt.session.scripts.tag': 'Skripte · {count}',
  'workbench.editors.mqtt.session.scripts.tagTitle': 'Sitzungsskripte',
  ...
  'workbench.editors.mqtt.session.scripts.runs': '{count} Läufe',
  'workbench.editors.mqtt.session.scripts.runsOne': '1 Lauf',
  'workbench.editors.mqtt.session.scripts.failed': '{count} fehlgeschlagen',
  'workbench.editors.mqtt.session.scripts.dropped': '{count} verworfen',
