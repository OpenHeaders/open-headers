...
export const workbenchSettings = {
  ...
  'workbench.settings.category.backend.label': 'Konnektivität · Back-end',
  'workbench.settings.category.backend.navLabel': 'Back-end',
  ...
  'workbench.settings.category.mcpClients.label': 'KI · MCP-Server · Clients',
  'workbench.settings.category.mcpClients.navLabel': 'Clients',
  'workbench.settings.category.mcpClients.description': 'Verbinde die oh-Kommandozeile und MCP-Clients mit dieser App.',
  'workbench.settings.category.mcpClients.sub.command-line': 'Kommandozeile',
  'workbench.settings.category.mcpClients.sub.configuration': 'Konfiguration',
  'workbench.settings.category.appearanceBehavior.label': 'Darstellung & Verhalten',
  'workbench.settings.category.appearanceBehavior.description':
    'Wie die App aussieht und sich verhält – Locale, Design und die Workbench-Hülle.',
  'workbench.settings.category.general.label': 'Darstellung & Verhalten · Allgemein',
  'workbench.settings.category.general.navLabel': 'Allgemein',
  ...
  'workbench.settings.category.general.sub.behavior': 'Verhalten',
  'workbench.settings.category.general.sub.settings': 'Einstellungen',
  'workbench.settings.category.general.sub.privacy': 'Datenschutz',
  'workbench.settings.category.appearance.label': 'Darstellung & Verhalten · Darstellung',
  'workbench.settings.category.appearance.navLabel': 'Darstellung',
  ...
  'workbench.settings.category.workspaceLayout.label': 'Darstellung & Verhalten · Arbeitsbereich-Layout',
  'workbench.settings.category.workspaceLayout.navLabel': 'Arbeitsbereich-Layout',
  ...
  'workbench.settings.category.devpanelLayout.sub.topbar': 'Obere Leiste',
  'workbench.settings.category.devpanelLayout.sub.footer': 'Fußzeile',
  ...
  'workbench.settings.category.editor.description': 'Die Code- und Diff-Flächen in jedem Editor-Tab.',
  'workbench.settings.category.codeEditor.label': 'Editor · Code-Editor',
  'workbench.settings.category.codeEditor.navLabel': 'Code-Editor',
  'workbench.settings.category.codeEditor.description':
    'Schrift, Einrückung und Ansichtsoptionen für Code-Bearbeitungsflächen.',
  'workbench.settings.category.codeEditor.sub.font': 'Schrift',
  'workbench.settings.category.codeEditor.sub.indentation': 'Einrückung',
  'workbench.settings.category.codeEditor.sub.wrapping': 'Zeilenumbruch',
  'workbench.settings.category.codeEditor.sub.display': 'Anzeige',
  ...
  'workbench.settings.category.git.label': 'Versionsverwaltung · Git',
  ...
  'workbench.settings.category.proxy.label': 'Konnektivität · Proxy',
  ...
  'workbench.settings.category.application.label': 'Anwendung',
  'workbench.settings.category.application.description': 'Die App selbst – Daten, Updates, Lizenz und Version.',
  'workbench.settings.category.data.label': 'Anwendung · Daten',
  'workbench.settings.category.data.navLabel': 'Daten',
  'workbench.settings.category.data.description': 'Diagnose, Import/Export und destruktive Wartung.',
  'workbench.settings.category.data.sub.settings': 'Einstellungen',
  'workbench.settings.category.data.sub.diagnostics': 'Diagnose',
  'workbench.settings.category.data.sub.importReports': 'Importberichte',
  'workbench.settings.category.data.sub.files': 'Dateien',
  'workbench.settings.category.license.label': 'Anwendung · Lizenz',
  'workbench.settings.category.license.navLabel': 'Lizenz',
  ...
  'workbench.settings.category.updates.label': 'Anwendung · Updates',
  'workbench.settings.category.updates.navLabel': 'Updates',
  ...
  'workbench.settings.category.about.label': 'Anwendung · Über',
  'workbench.settings.category.about.navLabel': 'Über',
