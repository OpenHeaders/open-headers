...
export const workbenchSettings = {
  ...
  'workbench.settings.category.mcpAccess.label': 'Zugriff',
  ...
  'workbench.settings.category.mcpClients.label': 'Clients',
  ...
  'workbench.settings.category.devpanel.description':
    ...
    'Anfragen-Oberfläche.',
  'workbench.settings.category.devpanelLayout.label': 'Layout',
  ...
  'workbench.settings.category.codeEditor.label': 'Code-Editor',
  ...
  'workbench.settings.category.diffViewer.label': 'Diff-Ansicht',
  ...
  'workbench.settings.category.git.description':
    ...
    'YAML-Baum.',
  'workbench.settings.category.gitFolder.label': 'Ordner',
  ...
  'workbench.settings.category.gitAutomation.label': 'Automatisierung',
  ...
  'workbench.settings.category.proxyOutbound.label': 'Ausgehende Anfragen',
  'workbench.settings.category.proxyOutbound.description':
    ...
    'Netzwerk erreichen.',
  'workbench.settings.category.proxyTrust.label': 'HTTPS-Vertrauen',
