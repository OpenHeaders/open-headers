...
export function buildSnapshotFromOracle(
  ...
  return {
    ...
    grpcRequests: snapshotGrpcRequestPostStates(workspaceId),
    websocketRequests: snapshotWebSocketRequestPostStates(workspaceId),
    mqttRequests: snapshotMqttRequestPostStates(workspaceId),
    graphqlRequests: snapshotGraphqlRequestPostStates(workspaceId),
    responseExamples: snapshotResponseExamplePostStates(workspaceId),
    grpcResponseExamples: snapshotGrpcResponseExamplePostStates(workspaceId),
    wsResponseExamples: snapshotWsResponseExamplePostStates(workspaceId),
    mqttResponseExamples: snapshotMqttResponseExamplePostStates(workspaceId),
    scriptPackages: snapshotScriptPackagePostStates(workspaceId),
    specs: snapshotSpecPostStates(workspaceId),
