 ...
 *
 * Host-neutral: every oracle-owning host answers
 * `findWorkspaceExportImportMatches` through this module. Pure read;
 * no locks. The banner is a UX hint, not a guard rail — users can
 * re-import the same export as many times as they want.
 */
