...
// Order-SENSITIVE signature — workspace vars now persist their row order
// as fractional-index keys (see `applyWorkspaceVariablesReplacement`), so
// the materialized order matches the editor's. Order-sensitivity is
// therefore correct AND load-bearing: a drag-reorder shifts the
// fingerprint, flips `isDirty`, and Save persists the new order.
