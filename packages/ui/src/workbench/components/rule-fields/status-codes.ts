/**
 * Shared option lists for response-rule status / content-type fields.
 * Consumed by the workbench editor (`ResponseRuleFields`) and the panel
 * quick-editor popover so both surfaces agree on labels and grouping.
 */
