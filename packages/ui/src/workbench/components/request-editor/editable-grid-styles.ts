...
.editable-grid-suggestion-row .editable-grid-suggestion-action,
.editable-grid-row .editable-grid-suggestion-action { opacity: 0; transition: opacity 120ms ease; }
.editable-grid-suggestion-row:hover .editable-grid-suggestion-action,
.editable-grid-row:hover .editable-grid-suggestion-action,
.editable-grid-suggestion-row .editable-grid-suggestion-action:focus-visible,
.editable-grid-row .editable-grid-suggestion-action:focus-visible { opacity: 1; }
