...
export const KeyboardRegionsDiagram: React.FC = () => {
  ...
  return (
    <svg
      ...
      style={{ maxWidth: 360 }}
      role="img"
      aria-label={t('workbench.docs.diagrams.keyboardShortcuts.aria')}
    >
      <text x={160} y={14} textAnchor="middle" fontSize={10} fontWeight={700} fill={TEXT}>
        {t('workbench.docs.diagrams.keyboardShortcuts.title')}
      </text>
      ...
      <text
        ...
        fill={TEXT_DIM}
      >
        {t('workbench.docs.diagrams.keyboardShortcuts.windowTitle')}
      </text>
      ...
      <text x={WB_X + LEFT_W / 2} y={WB_Y + TITLE_H + 14} textAnchor="middle" fontSize={9} fontWeight={700} fill={TEXT}>
        {t('workbench.docs.diagrams.keyboardShortcuts.leftSidebar')}
      </text>
      ...
      <text x={editorX + editorW / 2} y={editorY + 16} textAnchor="middle" fontSize={9} fontWeight={700} fill={TEXT}>
        {t('workbench.docs.diagrams.keyboardShortcuts.editor')}
      </text>
      ...
      <text
        ...
        fill={TEXT}
      >
        {t('workbench.docs.diagrams.keyboardShortcuts.rightSidebar')}
      </text>
      ...
      <text
        ...
        fill={TEXT}
      >
        {t('workbench.docs.diagrams.keyboardShortcuts.bottomPanel')}
      </text>
      ...
      <text x={160} y={232} textAnchor="middle" fontSize={9} fontStyle="italic" fill={TEXT_DIM}>
        {t('workbench.docs.diagrams.keyboardShortcuts.footer')}
      </text>
    </svg>
  );
};
