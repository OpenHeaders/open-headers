  ...
  return (
    <div className="oh-info-eg">
      ...
      <div className="oh-info-eg-card">
        {lines.map((line) => (
          <div className="oh-info-eg-line" key={line.opener ?? line.tokens[0]?.id}>
            {line.opener !== undefined && <span className="oh-info-eg-method">{line.opener}</span>}
