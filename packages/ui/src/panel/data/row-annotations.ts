...
const LABEL_KEY: Record<RowAnnotationMessage, MessageKey> = {
  ...
  'wire-joined': 'panel.rowAnnotations.systemProxyJoined.label',
  'wire-seen': 'panel.rowAnnotations.systemProxySeen.label',
};
...
const DETAIL_KEY: Record<RowAnnotationMessage, MessageKey> = {
  ...
  'wire-joined': 'panel.rowAnnotations.systemProxyJoined.detail',
  'wire-seen': 'panel.rowAnnotations.systemProxySeen.detail',
};
...
export function buildRowAnnotationMessages(t: Translate): RowAnnotationMessages {
  ...
  const unknownTab = t('panel.rowAnnotations.systemProxySeen.unknownTab');
  return {
    ...
    wireSeenJump: t('panel.rowAnnotations.systemProxySeen.jump'),
  };
}
