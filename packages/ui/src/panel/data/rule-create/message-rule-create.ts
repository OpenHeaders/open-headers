 ...
 *  modify, ws receive, sse default `message` events). */
 ...
 *  workspace" link carries the CURRENT form state. The draft and the
 *  quick draft always describe the same rule type — the quick draft was
 *  seeded from the draft and the kind is not editable. */
