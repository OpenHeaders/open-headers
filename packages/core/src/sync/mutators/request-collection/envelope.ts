/**
 * Internal helpers — mint envelopes + batches from request-collection
...
/** Request-collection mutator catalog version — bumped on any wire-incompatible change (§13.4). */
export const REQUEST_COLLECTION_MUTATOR_VERSION = 1;
