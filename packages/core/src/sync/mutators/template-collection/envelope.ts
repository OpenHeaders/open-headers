/**
 * Internal helpers — mint envelopes + batches from template-collection
...
/** Template-collection mutator catalog version — bumped on any wire-incompatible change (§13.4). */
export const TEMPLATE_COLLECTION_MUTATOR_VERSION = 1;
