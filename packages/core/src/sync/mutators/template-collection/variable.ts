...
const factories = makeVariableMutators({
  ...
  mintBatch,
  deriveSideEffects: deriveTemplateCollectionSideEffects,
});
...
export function setTemplateCollectionVar(ctx: MutatorContext, args: SetTemplateCollectionVarArgs): MutatorIntent {
...
export function removeTemplateCollectionVar(ctx: MutatorContext, args: RemoveTemplateCollectionVarArgs): MutatorIntent {
