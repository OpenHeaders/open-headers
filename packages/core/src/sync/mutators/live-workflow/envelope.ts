/**
 * Internal helpers — mint envelopes + batches from live-workflow
...
/** Live-workflow mutator catalog version — bump on any wire-incompatible change (§13.4). */
export const LIVE_WORKFLOW_MUTATOR_VERSION = 1;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: LIVE_WORKFLOW_MUTATOR_VERSION,
    body,
  };
}
