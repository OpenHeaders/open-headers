 ...
 * live-fallback-priority mutator arguments. Mirrors the other catalogs.
 */
...
/** Catalog version — bump on any wire-incompatible change (§13.4). */
export const LIVE_FALLBACK_PRIORITY_MUTATOR_VERSION = 1;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: LIVE_FALLBACK_PRIORITY_MUTATOR_VERSION,
    body,
  };
}
