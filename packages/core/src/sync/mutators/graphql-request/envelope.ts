/**
 * Internal helpers — mint envelopes + batches from GraphQL-request
...
/** GraphQL-request mutator catalog version — bump on any wire-incompatible change (§13.4). */
export const GRAPHQL_REQUEST_MUTATOR_VERSION = 1;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: GRAPHQL_REQUEST_MUTATOR_VERSION,
    body,
  };
}
