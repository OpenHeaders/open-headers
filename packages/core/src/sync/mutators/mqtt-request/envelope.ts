/**
 * Internal helpers — mint envelopes + batches from MQTT-request
...
/** MQTT-request mutator catalog version — bump on any wire-incompatible change (§13.4). */
export const MQTT_REQUEST_MUTATOR_VERSION = 2;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: MQTT_REQUEST_MUTATOR_VERSION,
    body,
  };
}
