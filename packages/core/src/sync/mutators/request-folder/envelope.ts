/**
 * Internal helpers — mint envelopes + batches from request-folder
...
/** Request-folder mutator catalog version — bumped on any wire-incompatible change (§13.4). */
export const REQUEST_FOLDER_MUTATOR_VERSION = 1;
