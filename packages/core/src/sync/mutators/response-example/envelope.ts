/**
 * Internal helpers — mint envelopes + batches from response-example
...
/** Response-example mutator catalog version — bump on any wire-incompatible change (§13.4). */
export const RESPONSE_EXAMPLE_MUTATOR_VERSION = 1;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: RESPONSE_EXAMPLE_MUTATOR_VERSION,
    body,
  };
}
