/**
 * Internal helpers — mint envelopes + batches from layout-state mutator
...
/** Layout-state mutator catalog version — bump on any wire-incompatible change (§13.4). */
export const LAYOUT_STATE_MUTATOR_VERSION = 1;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: LAYOUT_STATE_MUTATOR_VERSION,
    body,
  };
}
