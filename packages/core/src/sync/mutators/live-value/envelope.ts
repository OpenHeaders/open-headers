/**
 * Internal helpers — mint envelopes + batches from live-value mutator
...
/** Live-value mutator catalog version — bump on any wire-incompatible change (§13.4). */
export const LIVE_VALUE_MUTATOR_VERSION = 1;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: LIVE_VALUE_MUTATOR_VERSION,
    body,
  };
}
