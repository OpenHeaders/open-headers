/**
 * Internal helpers — mint envelopes + batches from spec mutator
...
/** Spec mutator catalog version — bump on any wire-incompatible change (§13.4). */
export const SPEC_MUTATOR_VERSION = 1;
...
export function mintEnvelope(ctx: MutatorContext, body: MutationBody): MutationEnvelope {
  return {
    ...
    mutatorVersion: SPEC_MUTATOR_VERSION,
    body,
  };
}
