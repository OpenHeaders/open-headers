/**
 * Node-host live Status pill (WS-C C5) — cache-row aggregation → pill color.
 *
...
import { recomputeLiveStatus } from '../../../src/daemon/live/live-status';
